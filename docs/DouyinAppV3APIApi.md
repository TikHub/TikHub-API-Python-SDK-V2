# tikhub_sdk_v2.DouyinAppV3APIApi
...
[**fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get_0**](DouyinAppV3APIApi.md#fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get_0) | **GET** /api/v1/douyin/app/v3/fetch_video_comments | 获取单个视频评论数据/Get single video comments data
...
filter_duration = '0' # str | 时长/Duration (optional) (default to '0')
content_type = '0' # str | 内容类型/Content type (optional) (default to '0')

    try:
        # 获取指定关键词的综合搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_general_search_result）/Get comprehensive search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_general_search_result)
        api_response = api_instance.fetch_general_search_result_api_v1_douyin_app_v3_fetch_general_search_result_get(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, content_type=content_type)
        pprint(api_response)
    except ApiException as e:
...
content_type = '0' # str | 内容类型/Content type (optional) (default to '0')
    ...
    try:
        # 获取指定关键词的综合搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_general_search_result）/Get comprehensive search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_general_search_result)
        api_response = api_instance.fetch_general_search_result_api_v1_douyin_app_v3_fetch_general_search_result_get_0(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, content_type=content_type)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_hashtag_search_result_api_v1_douyin_app_v3_fetch_hashtag_search_result_get_0**
> ResponseModel fetch_hashtag_search_result_api_v1_douyin_app_v3_fetch_hashtag_search_result_get_0(keyword, offset=offset, count=count)
...
board_sub_type = '' # str | 榜单子类型/Board sub type (optional) (default to '')
    ...
    try:
        # 获取抖音热搜榜数据/Get Douyin hot search list data
        api_response = api_instance.fetch_hot_search_list_api_v1_douyin_app_v3_fetch_hot_search_list_get(board_type=board_type, board_sub_type=board_sub_type)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_live_search_result_api_v1_douyin_app_v3_fetch_live_search_result_get_0**
> ResponseModel fetch_live_search_result_api_v1_douyin_app_v3_fetch_live_search_result_get_0(keyword, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        ...
        print("Exception when calling DouyinAppV3APIApi->fetch_live_search_result_api_v1_douyin_app_v3_fetch_live_search_result_get_0: %s\n" % e)
```
...
> ResponseModel fetch_multi_video_api_v1_douyin_app_v3_fetch_multi_video_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 批量获取视频信息/Batch Get Video Information
        api_response = api_instance.fetch_multi_video_api_v1_douyin_app_v3_fetch_multi_video_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_multi_video_api_v1_douyin_app_v3_fetch_multi_video_post_0**
> ResponseModel fetch_multi_video_api_v1_douyin_app_v3_fetch_multi_video_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 批量获取视频信息/Batch Get Video Information
        api_response = api_instance.fetch_multi_video_api_v1_douyin_app_v3_fetch_multi_video_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_multi_video_api_v1_douyin_app_v3_fetch_multi_video_post_0: %s\n" % e)
```
...
# **fetch_multi_video_statistics_api_v1_douyin_app_v3_fetch_multi_video_statistics_get**
> ResponseModel fetch_multi_video_statistics_api_v1_douyin_app_v3_fetch_multi_video_statistics_get(aweme_ids)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据视频ID批量获取作品的统计数据（点赞数、下载数、播放数、分享数）/Get the statistical data of the Post according to the video ID (like count, download count, play count, share count)
        api_response = api_instance.fetch_multi_video_statistics_api_v1_douyin_app_v3_fetch_multi_video_statistics_get(aweme_ids)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_multi_video_statistics_api_v1_douyin_app_v3_fetch_multi_video_statistics_get_0**
> ResponseModel fetch_multi_video_statistics_api_v1_douyin_app_v3_fetch_multi_video_statistics_get_0(aweme_ids)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据视频ID批量获取作品的统计数据（点赞数、下载数、播放数、分享数）/Get the statistical data of the Post according to the video ID (like count, download count, play count, share count)
        api_response = api_instance.fetch_multi_video_statistics_api_v1_douyin_app_v3_fetch_multi_video_statistics_get_0(aweme_ids)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_multi_video_statistics_api_v1_douyin_app_v3_fetch_multi_video_statistics_get_0: %s\n" % e)
```
...
> ResponseModel fetch_music_detail_api_v1_douyin_app_v3_fetch_music_detail_get(music_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取指定音乐的详情数据/Get details of specified music
        api_response = api_instance.fetch_music_detail_api_v1_douyin_app_v3_fetch_music_detail_get(music_id)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_music_detail_api_v1_douyin_app_v3_fetch_music_detail_get_0**
> ResponseModel fetch_music_detail_api_v1_douyin_app_v3_fetch_music_detail_get_0(music_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取指定音乐的详情数据/Get details of specified music
        api_response = api_instance.fetch_music_detail_api_v1_douyin_app_v3_fetch_music_detail_get_0(music_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_music_detail_api_v1_douyin_app_v3_fetch_music_detail_get_0: %s\n" % e)
```
...
> ResponseModel fetch_music_hot_search_list_api_v1_douyin_app_v3_fetch_music_hot_search_list_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取抖音音乐热榜数据/Get Douyin music hot search list data
        api_response = api_instance.fetch_music_hot_search_list_api_v1_douyin_app_v3_fetch_music_hot_search_list_get()
        pprint(api_response)
    except ApiException as e:
...
# **fetch_music_hot_search_list_api_v1_douyin_app_v3_fetch_music_hot_search_list_get_0**
> ResponseModel fetch_music_hot_search_list_api_v1_douyin_app_v3_fetch_music_hot_search_list_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取抖音音乐热榜数据/Get Douyin music hot search list data
        api_response = api_instance.fetch_music_hot_search_list_api_v1_douyin_app_v3_fetch_music_hot_search_list_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_music_hot_search_list_api_v1_douyin_app_v3_fetch_music_hot_search_list_get_0: %s\n" % e)
```
...
# **fetch_music_search_result_api_v1_douyin_app_v3_fetch_music_search_result_get**
> ResponseModel fetch_music_search_result_api_v1_douyin_app_v3_fetch_music_search_result_get(keyword, offset=offset, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取指定关键词的音乐搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_music_search_result）/Get music search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_music_search_result)
        api_response = api_instance.fetch_music_search_result_api_v1_douyin_app_v3_fetch_music_search_result_get(keyword, offset=offset, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_music_search_result_api_v1_douyin_app_v3_fetch_music_search_result_get_0**
> ResponseModel fetch_music_search_result_api_v1_douyin_app_v3_fetch_music_search_result_get_0(keyword, offset=offset, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取指定关键词的音乐搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_music_search_result）/Get music search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_music_search_result)
        api_response = api_instance.fetch_music_search_result_api_v1_douyin_app_v3_fetch_music_search_result_get_0(keyword, offset=offset, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_music_search_result_api_v1_douyin_app_v3_fetch_music_search_result_get_0: %s\n" % e)
```
...
> ResponseModel fetch_music_video_list_api_v1_douyin_app_v3_fetch_music_video_list_get(music_id, cursor=cursor, count=count)
...
count = 10 # int | 数量/Number (optional) (default to 10)
    ...
    try:
        # 获取指定音乐的视频列表数据/Get video list of specified music
        api_response = api_instance.fetch_music_video_list_api_v1_douyin_app_v3_fetch_music_video_list_get(music_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_music_video_list_api_v1_douyin_app_v3_fetch_music_video_list_get_0**
> ResponseModel fetch_music_video_list_api_v1_douyin_app_v3_fetch_music_video_list_get_0(music_id, cursor=cursor, count=count)
...
count = 10 # int | 数量/Number (optional) (default to 10)
    ...
    try:
        # 获取指定音乐的视频列表数据/Get video list of specified music
        api_response = api_instance.fetch_music_video_list_api_v1_douyin_app_v3_fetch_music_video_list_get_0(music_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_music_video_list_api_v1_douyin_app_v3_fetch_music_video_list_get_0: %s\n" % e)
```
...
> ResponseModel fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_get(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据/Get single video data
        api_response = api_instance.fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_get(aweme_id)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_get_0**
> ResponseModel fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_get_0(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据/Get single video data
        api_response = api_instance.fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_get_0(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_get_0: %s\n" % e)
```
...
# **fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get**
> ResponseModel fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据/Get single video data
        api_response = api_instance.fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get: %s\n" % e)
```
...
# **fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get_0**
> ResponseModel fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get_0(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据/Get single video data
        api_response = api_instance.fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get_0(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_one_video_api_v1_douyin_app_v3_fetch_one_video_v2_get_0: %s\n" % e)
```
...
> ResponseModel fetch_one_video_by_share_url_api_v1_douyin_app_v3_fetch_one_video_by_share_url_get(share_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据分享链接获取单个作品数据/Get single video data by sharing link
        api_response = api_instance.fetch_one_video_by_share_url_api_v1_douyin_app_v3_fetch_one_video_by_share_url_get(share_url)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_one_video_by_share_url_api_v1_douyin_app_v3_fetch_one_video_by_share_url_get_0**
> ResponseModel fetch_one_video_by_share_url_api_v1_douyin_app_v3_fetch_one_video_by_share_url_get_0(share_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据分享链接获取单个作品数据/Get single video data by sharing link
        api_response = api_instance.fetch_one_video_by_share_url_api_v1_douyin_app_v3_fetch_one_video_by_share_url_get_0(share_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_one_video_by_share_url_api_v1_douyin_app_v3_fetch_one_video_by_share_url_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_fans_list_api_v1_douyin_app_v3_fetch_user_fans_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取用户粉丝列表/Get user fans list
        api_response = api_instance.fetch_user_fans_list_api_v1_douyin_app_v3_fetch_user_fans_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_fans_list_api_v1_douyin_app_v3_fetch_user_fans_list_get_0**
> ResponseModel fetch_user_fans_list_api_v1_douyin_app_v3_fetch_user_fans_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取用户粉丝列表/Get user fans list
        api_response = api_instance.fetch_user_fans_list_api_v1_douyin_app_v3_fetch_user_fans_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_user_fans_list_api_v1_douyin_app_v3_fetch_user_fans_list_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_following_list_api_v1_douyin_app_v3_fetch_user_following_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取用户关注列表/Get user following list
        api_response = api_instance.fetch_user_following_list_api_v1_douyin_app_v3_fetch_user_following_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_following_list_api_v1_douyin_app_v3_fetch_user_following_list_get_0**
> ResponseModel fetch_user_following_list_api_v1_douyin_app_v3_fetch_user_following_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取用户关注列表/Get user following list
        api_response = api_instance.fetch_user_following_list_api_v1_douyin_app_v3_fetch_user_following_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_user_following_list_api_v1_douyin_app_v3_fetch_user_following_list_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_like_videos_api_v1_douyin_app_v3_fetch_user_like_videos_get(sec_user_id, max_cursor=max_cursor, counts=counts)
...
counts = 20 # int | 每页数量/Number per page (optional) (default to 20)
    ...
    try:
        # 获取用户喜欢作品数据/Get user like video data
        api_response = api_instance.fetch_user_like_videos_api_v1_douyin_app_v3_fetch_user_like_videos_get(sec_user_id, max_cursor=max_cursor, counts=counts)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_like_videos_api_v1_douyin_app_v3_fetch_user_like_videos_get_0**
> ResponseModel fetch_user_like_videos_api_v1_douyin_app_v3_fetch_user_like_videos_get_0(sec_user_id, max_cursor=max_cursor, counts=counts)
...
counts = 20 # int | 每页数量/Number per page (optional) (default to 20)
    ...
    try:
        # 获取用户喜欢作品数据/Get user like video data
        api_response = api_instance.fetch_user_like_videos_api_v1_douyin_app_v3_fetch_user_like_videos_get_0(sec_user_id, max_cursor=max_cursor, counts=counts)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_user_like_videos_api_v1_douyin_app_v3_fetch_user_like_videos_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_post_videos_api_v1_douyin_app_v3_fetch_user_post_videos_get(sec_user_id, max_cursor=max_cursor, count=count)
...
count = 20 # int | 每页数量/Number per page (optional) (default to 20)
    ...
    try:
        # 获取用户主页作品数据/Get user homepage video data
        api_response = api_instance.fetch_user_post_videos_api_v1_douyin_app_v3_fetch_user_post_videos_get(sec_user_id, max_cursor=max_cursor, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_post_videos_api_v1_douyin_app_v3_fetch_user_post_videos_get_0**
> ResponseModel fetch_user_post_videos_api_v1_douyin_app_v3_fetch_user_post_videos_get_0(sec_user_id, max_cursor=max_cursor, count=count)
...
count = 20 # int | 每页数量/Number per page (optional) (default to 20)
    ...
    try:
        # 获取用户主页作品数据/Get user homepage video data
        api_response = api_instance.fetch_user_post_videos_api_v1_douyin_app_v3_fetch_user_post_videos_get_0(sec_user_id, max_cursor=max_cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_user_post_videos_api_v1_douyin_app_v3_fetch_user_post_videos_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_search_result_api_v1_douyin_app_v3_fetch_user_search_result_get(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type)
...
douyin_user_type = '' # str | 用户类型/User type (optional) (default to '')
    ...
    try:
        # 获取指定关键词的用户搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_user_search_result_v2）/Get user search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_user_search_result_v2)
        api_response = api_instance.fetch_user_search_result_api_v1_douyin_app_v3_fetch_user_search_result_get(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_search_result_api_v1_douyin_app_v3_fetch_user_search_result_get_0**
> ResponseModel fetch_user_search_result_api_v1_douyin_app_v3_fetch_user_search_result_get_0(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type)
...
douyin_user_type = '' # str | 用户类型/User type (optional) (default to '')
    ...
    try:
        # 获取指定关键词的用户搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_user_search_result_v2）/Get user search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_user_search_result_v2)
        api_response = api_instance.fetch_user_search_result_api_v1_douyin_app_v3_fetch_user_search_result_get_0(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_user_search_result_api_v1_douyin_app_v3_fetch_user_search_result_get_0: %s\n" % e)
```
...
> ResponseModel fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get(aweme_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取单个视频评论数据/Get single video comments data
        api_response = api_instance.fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get(aweme_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get_0**
> ResponseModel fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get_0(aweme_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取单个视频评论数据/Get single video comments data
        api_response = api_instance.fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get_0(aweme_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_video_comments_api_v1_douyin_app_v3_fetch_video_comments_get_0: %s\n" % e)
```
...
> ResponseModel fetch_video_comments_reply_api_v1_douyin_app_v3_fetch_video_comment_replies_get(item_id, comment_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取指定视频的评论回复数据/Get comment replies data of specified video
        api_response = api_instance.fetch_video_comments_reply_api_v1_douyin_app_v3_fetch_video_comment_replies_get(item_id, comment_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_video_comments_reply_api_v1_douyin_app_v3_fetch_video_comment_replies_get_0**
> ResponseModel fetch_video_comments_reply_api_v1_douyin_app_v3_fetch_video_comment_replies_get_0(item_id, comment_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取指定视频的评论回复数据/Get comment replies data of specified video
        api_response = api_instance.fetch_video_comments_reply_api_v1_douyin_app_v3_fetch_video_comment_replies_get_0(item_id, comment_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_video_comments_reply_api_v1_douyin_app_v3_fetch_video_comment_replies_get_0: %s\n" % e)
```
...
> ResponseModel fetch_video_mix_detail_api_v1_douyin_app_v3_fetch_video_mix_detail_get(mix_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinAppV3APIApi(api_client)
    mix_id = '7302011174286002217' # str | 合集id/Mix id

    try:
        # 获取抖音视频合集详情数据/Get Douyin video mix detail data
        api_response = api_instance.fetch_video_mix_detail_api_v1_douyin_app_v3_fetch_video_mix_detail_get(mix_id)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_video_mix_detail_api_v1_douyin_app_v3_fetch_video_mix_detail_get_0**
> ResponseModel fetch_video_mix_detail_api_v1_douyin_app_v3_fetch_video_mix_detail_get_0(mix_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取抖音视频合集详情数据/Get Douyin video mix detail data
        api_response = api_instance.fetch_video_mix_detail_api_v1_douyin_app_v3_fetch_video_mix_detail_get_0(mix_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_video_mix_detail_api_v1_douyin_app_v3_fetch_video_mix_detail_get_0: %s\n" % e)
```
...
> ResponseModel fetch_video_mix_post_list_api_v1_douyin_app_v3_fetch_video_mix_post_list_get(mix_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取抖音视频合集作品列表数据/Get Douyin video mix post list data
        api_response = api_instance.fetch_video_mix_post_list_api_v1_douyin_app_v3_fetch_video_mix_post_list_get(mix_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_video_mix_post_list_api_v1_douyin_app_v3_fetch_video_mix_post_list_get_0**
> ResponseModel fetch_video_mix_post_list_api_v1_douyin_app_v3_fetch_video_mix_post_list_get_0(mix_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取抖音视频合集作品列表数据/Get Douyin video mix post list data
        api_response = api_instance.fetch_video_mix_post_list_api_v1_douyin_app_v3_fetch_video_mix_post_list_get_0(mix_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_video_mix_post_list_api_v1_douyin_app_v3_fetch_video_mix_post_list_get_0: %s\n" % e)
```
...
> ResponseModel fetch_video_search_result_api_v1_douyin_app_v3_fetch_video_search_result_get(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration)
...
filter_duration = '0' # str | 时长/Duration (optional) (default to '0')
    ...
    try:
        # 获取指定关键词的视频搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_video_search_result）/Get video search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_video_search_result)
        api_response = api_instance.fetch_video_search_result_api_v1_douyin_app_v3_fetch_video_search_result_get(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_video_search_result_api_v1_douyin_app_v3_fetch_video_search_result_get_0**
> ResponseModel fetch_video_search_result_api_v1_douyin_app_v3_fetch_video_search_result_get_0(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration)
...
filter_duration = '0' # str | 时长/Duration (optional) (default to '0')
    ...
    try:
        # 获取指定关键词的视频搜索结果（弃用，替代接口：/api/v1/douyin/web/fetch_video_search_result）/Get video search results of specified keywords (deprecated, alternative interface: /api/v1/douyin/web/fetch_video_search_result)
        api_response = api_instance.fetch_video_search_result_api_v1_douyin_app_v3_fetch_video_search_result_get_0(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_video_search_result_api_v1_douyin_app_v3_fetch_video_search_result_get_0: %s\n" % e)
```
...
> ResponseModel fetch_video_search_result_v2_api_v1_douyin_app_v3_fetch_video_search_result_v2_get(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的视频搜索结果V2/Get video search results of specified keywords V2
        api_response = api_instance.fetch_video_search_result_v2_api_v1_douyin_app_v3_fetch_video_search_result_v2_get(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_video_search_result_v2_api_v1_douyin_app_v3_fetch_video_search_result_v2_get_0**
> ResponseModel fetch_video_search_result_v2_api_v1_douyin_app_v3_fetch_video_search_result_v2_get_0(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的视频搜索结果V2/Get video search results of specified keywords V2
        api_response = api_instance.fetch_video_search_result_v2_api_v1_douyin_app_v3_fetch_video_search_result_v2_get_0(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_video_search_result_v2_api_v1_douyin_app_v3_fetch_video_search_result_v2_get_0: %s\n" % e)
```
...
> ResponseModel fetch_video_statistics_api_v1_douyin_app_v3_fetch_video_statistics_get(aweme_ids)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据视频ID获取作品的统计数据（点赞数、下载数、播放数、分享数）/Get the statistical data of the Post according to the video ID (like count, download count, play count, share count)
        api_response = api_instance.fetch_video_statistics_api_v1_douyin_app_v3_fetch_video_statistics_get(aweme_ids)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_video_statistics_api_v1_douyin_app_v3_fetch_video_statistics_get_0**
> ResponseModel fetch_video_statistics_api_v1_douyin_app_v3_fetch_video_statistics_get_0(aweme_ids)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据视频ID获取作品的统计数据（点赞数、下载数、播放数、分享数）/Get the statistical data of the Post according to the video ID (like count, download count, play count, share count)
        api_response = api_instance.fetch_video_statistics_api_v1_douyin_app_v3_fetch_video_statistics_get_0(aweme_ids)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->fetch_video_statistics_api_v1_douyin_app_v3_fetch_video_statistics_get_0: %s\n" % e)
```
...
> ResponseModel generate_douyin_short_url_api_v1_douyin_app_v3_generate_douyin_short_url_get(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinAppV3APIApi(api_client)
    url = 'https://www.douyin.com/passport/web/logout/' # str | 抖音链接/Douyin link

    try:
        # 生成抖音短链接/Generate Douyin short link
        api_response = api_instance.generate_douyin_short_url_api_v1_douyin_app_v3_generate_douyin_short_url_get(url)
        pprint(api_response)
    except ApiException as e:
...
# **generate_douyin_short_url_api_v1_douyin_app_v3_generate_douyin_short_url_get_0**
> ResponseModel generate_douyin_short_url_api_v1_douyin_app_v3_generate_douyin_short_url_get_0(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成抖音短链接/Generate Douyin short link
        api_response = api_instance.generate_douyin_short_url_api_v1_douyin_app_v3_generate_douyin_short_url_get_0(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->generate_douyin_short_url_api_v1_douyin_app_v3_generate_douyin_short_url_get_0: %s\n" % e)
```
...
# **generate_douyin_video_share_qrcode_api_v1_douyin_app_v3_generate_douyin_video_share_qrcode_get**
> ResponseModel generate_douyin_video_share_qrcode_api_v1_douyin_app_v3_generate_douyin_video_share_qrcode_get(object_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinAppV3APIApi(api_client)
    object_id = '7348044435755846962' # str | 作品id/Video id

    try:
        # 生成抖音视频分享二维码/Generate Douyin video share QR code
        api_response = api_instance.generate_douyin_video_share_qrcode_api_v1_douyin_app_v3_generate_douyin_video_share_qrcode_get(object_id)
        pprint(api_response)
    except ApiException as e:
...
# **generate_douyin_video_share_qrcode_api_v1_douyin_app_v3_generate_douyin_video_share_qrcode_get_0**
> ResponseModel generate_douyin_video_share_qrcode_api_v1_douyin_app_v3_generate_douyin_video_share_qrcode_get_0(object_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成抖音视频分享二维码/Generate Douyin video share QR code
        api_response = api_instance.generate_douyin_video_share_qrcode_api_v1_douyin_app_v3_generate_douyin_video_share_qrcode_get_0(object_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->generate_douyin_video_share_qrcode_api_v1_douyin_app_v3_generate_douyin_video_share_qrcode_get_0: %s\n" % e)
```
...
> ResponseModel handler_user_profile_api_v1_douyin_app_v3_handler_user_profile_get(sec_user_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取指定用户的信息/Get information of specified user
        api_response = api_instance.handler_user_profile_api_v1_douyin_app_v3_handler_user_profile_get(sec_user_id)
        pprint(api_response)
    except ApiException as e:
...
# **handler_user_profile_api_v1_douyin_app_v3_handler_user_profile_get_0**
> ResponseModel handler_user_profile_api_v1_douyin_app_v3_handler_user_profile_get_0(sec_user_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取指定用户的信息/Get information of specified user
        api_response = api_instance.handler_user_profile_api_v1_douyin_app_v3_handler_user_profile_get_0(sec_user_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->handler_user_profile_api_v1_douyin_app_v3_handler_user_profile_get_0: %s\n" % e)
```
...
# **open_douyin_app_to_keyword_search_api_v1_douyin_app_v3_open_douyin_app_to_keyword_search_get**
> ResponseModel open_douyin_app_to_keyword_search_api_v1_douyin_app_v3_open_douyin_app_to_keyword_search_get(keyword)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinAppV3APIApi(api_client)
    keyword = '雷军' # str | 关键词/Keyword

    try:
        # 生成抖音分享链接，唤起抖音APP，跳转指定关键词搜索结果/Generate Douyin share link, call Douyin APP, and jump to the specified keyword search result
        api_response = api_instance.open_douyin_app_to_keyword_search_api_v1_douyin_app_v3_open_douyin_app_to_keyword_search_get(keyword)
        pprint(api_response)
    except ApiException as e:
...
# **open_douyin_app_to_keyword_search_api_v1_douyin_app_v3_open_douyin_app_to_keyword_search_get_0**
> ResponseModel open_douyin_app_to_keyword_search_api_v1_douyin_app_v3_open_douyin_app_to_keyword_search_get_0(keyword)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成抖音分享链接，唤起抖音APP，跳转指定关键词搜索结果/Generate Douyin share link, call Douyin APP, and jump to the specified keyword search result
        api_response = api_instance.open_douyin_app_to_keyword_search_api_v1_douyin_app_v3_open_douyin_app_to_keyword_search_get_0(keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->open_douyin_app_to_keyword_search_api_v1_douyin_app_v3_open_douyin_app_to_keyword_search_get_0: %s\n" % e)
```
...
# **open_douyin_app_to_send_private_message_api_v1_douyin_app_v3_open_douyin_app_to_send_private_message_get**
> ResponseModel open_douyin_app_to_send_private_message_api_v1_douyin_app_v3_open_douyin_app_to_send_private_message_get(uid, sec_uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinAppV3APIApi(api_client)
    uid = '96874812426' # str | 用户id/User id
sec_uid = 'MS4wLjABAAAA9y04iBlVdeMQqTJbqsQZKb-tqWqWW29jPVJqideHT70' # str | 用户sec_uid/User sec_uid

    try:
        # 生成抖音分享链接，唤起抖音APP，给指定用户发送私信/Generate Douyin share link, call Douyin APP, and send private messages to specified users
        api_response = api_instance.open_douyin_app_to_send_private_message_api_v1_douyin_app_v3_open_douyin_app_to_send_private_message_get(uid, sec_uid)
        pprint(api_response)
    except ApiException as e:
...
# **open_douyin_app_to_send_private_message_api_v1_douyin_app_v3_open_douyin_app_to_send_private_message_get_0**
> ResponseModel open_douyin_app_to_send_private_message_api_v1_douyin_app_v3_open_douyin_app_to_send_private_message_get_0(uid, sec_uid)
...
sec_uid = 'MS4wLjABAAAA9y04iBlVdeMQqTJbqsQZKb-tqWqWW29jPVJqideHT70' # str | 用户sec_uid/User sec_uid
    ...
    try:
        # 生成抖音分享链接，唤起抖音APP，给指定用户发送私信/Generate Douyin share link, call Douyin APP, and send private messages to specified users
        api_response = api_instance.open_douyin_app_to_send_private_message_api_v1_douyin_app_v3_open_douyin_app_to_send_private_message_get_0(uid, sec_uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->open_douyin_app_to_send_private_message_api_v1_douyin_app_v3_open_douyin_app_to_send_private_message_get_0: %s\n" % e)
```
...
# **open_douyin_app_to_user_profile_api_v1_douyin_app_v3_open_douyin_app_to_user_profile_get**
> ResponseModel open_douyin_app_to_user_profile_api_v1_douyin_app_v3_open_douyin_app_to_user_profile_get(uid, sec_uid)
...
sec_uid = 'MS4wLjABAAAA9y04iBlVdeMQqTJbqsQZKb-tqWqWW29jPVJqideHT70' # str | 用户sec_uid/User sec_uid
    ...
    try:
        # 生成抖音分享链接，唤起抖音APP，跳转指定用户主页/Generate Douyin share link, call Douyin APP, and jump to the specified user profile
        api_response = api_instance.open_douyin_app_to_user_profile_api_v1_douyin_app_v3_open_douyin_app_to_user_profile_get(uid, sec_uid)
        pprint(api_response)
    except ApiException as e:
...
# **open_douyin_app_to_user_profile_api_v1_douyin_app_v3_open_douyin_app_to_user_profile_get_0**
> ResponseModel open_douyin_app_to_user_profile_api_v1_douyin_app_v3_open_douyin_app_to_user_profile_get_0(uid, sec_uid)
...
sec_uid = 'MS4wLjABAAAA9y04iBlVdeMQqTJbqsQZKb-tqWqWW29jPVJqideHT70' # str | 用户sec_uid/User sec_uid
    ...
    try:
        # 生成抖音分享链接，唤起抖音APP，跳转指定用户主页/Generate Douyin share link, call Douyin APP, and jump to the specified user profile
        api_response = api_instance.open_douyin_app_to_user_profile_api_v1_douyin_app_v3_open_douyin_app_to_user_profile_get_0(uid, sec_uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->open_douyin_app_to_user_profile_api_v1_douyin_app_v3_open_douyin_app_to_user_profile_get_0: %s\n" % e)
```
...
# **open_douyin_app_to_video_detail_api_v1_douyin_app_v3_open_douyin_app_to_video_detail_get**
> ResponseModel open_douyin_app_to_video_detail_api_v1_douyin_app_v3_open_douyin_app_to_video_detail_get(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinAppV3APIApi(api_client)
    aweme_id = '7348044435755846962' # str | 作品id/Video id

    try:
        # 生成抖音分享链接，唤起抖音APP，跳转指定作品详情页/Generate Douyin share link, call Douyin APP, and jump to the specified video details page
        api_response = api_instance.open_douyin_app_to_video_detail_api_v1_douyin_app_v3_open_douyin_app_to_video_detail_get(aweme_id)
        pprint(api_response)
    except ApiException as e:
...
# **open_douyin_app_to_video_detail_api_v1_douyin_app_v3_open_douyin_app_to_video_detail_get_0**
> ResponseModel open_douyin_app_to_video_detail_api_v1_douyin_app_v3_open_douyin_app_to_video_detail_get_0(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成抖音分享链接，唤起抖音APP，跳转指定作品详情页/Generate Douyin share link, call Douyin APP, and jump to the specified video details page
        api_response = api_instance.open_douyin_app_to_video_detail_api_v1_douyin_app_v3_open_douyin_app_to_video_detail_get_0(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->open_douyin_app_to_video_detail_api_v1_douyin_app_v3_open_douyin_app_to_video_detail_get_0: %s\n" % e)
```
...
> ResponseModel register_device_api_v1_douyin_app_v3_register_device_get(proxy=proxy)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 抖音APP注册设备/Douyin APP register device
        api_response = api_instance.register_device_api_v1_douyin_app_v3_register_device_get(proxy=proxy)
        pprint(api_response)
    except ApiException as e:
...
# **register_device_api_v1_douyin_app_v3_register_device_get_0**
> ResponseModel register_device_api_v1_douyin_app_v3_register_device_get_0(proxy=proxy)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 抖音APP注册设备/Douyin APP register device
        api_response = api_instance.register_device_api_v1_douyin_app_v3_register_device_get_0(proxy=proxy)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinAppV3APIApi->register_device_api_v1_douyin_app_v3_register_device_get_0: %s\n" % e)
```
