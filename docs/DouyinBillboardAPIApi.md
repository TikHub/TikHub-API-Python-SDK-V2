# tikhub_sdk_v2.DouyinBillboardAPIApi
...
[**fetch_hot_account_list_api_v1_douyin_billboard_fetch_hot_account_list_post_0**](DouyinBillboardAPIApi.md#fetch_hot_account_list_api_v1_douyin_billboard_fetch_hot_account_list_post_0) | **POST** /api/v1/douyin/billboard/fetch_hot_account_list | 获取热门账号
...
[**fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post**](DouyinBillboardAPIApi.md#fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post) | **POST** /api/v1/douyin/billboard/fetch_hot_total_high_fan_list | 获取高涨粉率榜
...
[**fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post_0**](DouyinBillboardAPIApi.md#fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post_0) | **POST** /api/v1/douyin/billboard/fetch_hot_total_search_list | 获取搜索榜
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取垂类内容标签
        api_response = api_instance.fetch_content_tag_api_v1_douyin_billboard_fetch_content_tag_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_content_tag_api_v1_douyin_billboard_fetch_content_tag_get: %s\n" % e)
```
...
# **fetch_content_tag_api_v1_douyin_billboard_fetch_content_tag_get_0**
> ResponseModel fetch_content_tag_api_v1_douyin_billboard_fetch_content_tag_get_0()
...
> ResponseModel fetch_hot_account_fans_portrait_list_api_v1_douyin_billboard_fetch_hot_account_fans_portrait_list_get_0(sec_uid, option)
...
> ResponseModel fetch_hot_account_trends_list_api_v1_douyin_billboard_fetch_hot_account_trends_list_get(sec_uid, option, date_window)
...
# **fetch_hot_calendar_list_api_v1_douyin_billboard_fetch_hot_calendar_list_post**
> ResponseModel fetch_hot_calendar_list_api_v1_douyin_billboard_fetch_hot_calendar_list_post(unknown_base_type=unknown_base_type)
...
# **fetch_hot_category_list_api_v1_douyin_billboard_fetch_hot_category_list_get_0**
> ResponseModel fetch_hot_category_list_api_v1_douyin_billboard_fetch_hot_category_list_get_0(billboard_type, snapshot_time=snapshot_time, start_date=start_date, end_date=end_date, keyword=keyword)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    api_instance = tikhub_sdk_v2.DouyinBillboardAPIApi(api_client)
    page = 1 # int | 页码
page_size = 10 # int | 每页数量
keyword = '' # str | 热点搜索词 (optional) (default to '')

    try:
        # 获取挑战榜
        api_response = api_instance.fetch_hot_challenge_list_api_v1_douyin_billboard_fetch_hot_challenge_list_get(page, page_size, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_challenge_list_api_v1_douyin_billboard_fetch_hot_challenge_list_get: %s\n" % e)
```
...
# **fetch_hot_challenge_list_api_v1_douyin_billboard_fetch_hot_challenge_list_get_0**
> ResponseModel fetch_hot_challenge_list_api_v1_douyin_billboard_fetch_hot_challenge_list_get_0(page, page_size, keyword=keyword)
...
keyword = '' # str | 热点搜索词 (optional) (default to '')
    ...
    try:
        # 获取挑战榜
        api_response = api_instance.fetch_hot_challenge_list_api_v1_douyin_billboard_fetch_hot_challenge_list_get_0(page, page_size, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_challenge_list_api_v1_douyin_billboard_fetch_hot_challenge_list_get_0: %s\n" % e)
```
...
# **fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get**
> ResponseModel fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get(page, page_size, order, city_code=city_code, sentence_tag=sentence_tag, keyword=keyword)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    page = 1 # int | 页码
page_size = 10 # int | 每页数量
order = 'order_example' # str | 排序方式
city_code = '' # str | 城市编码，从城市列表获取，空为全部 (optional) (default to '')
sentence_tag = '' # str | 热点分类标签，从热点榜分类获取，多个分类用逗号分隔，空为全部 (optional) (default to '')
keyword = '' # str | 热点搜索词 (optional) (default to '')

    try:
        # 获取同城热点榜
        api_response = api_instance.fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get(page, page_size, order, city_code=city_code, sentence_tag=sentence_tag, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get: %s\n" % e)
```
...
# **fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get_0**
> ResponseModel fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get_0(page, page_size, order, city_code=city_code, sentence_tag=sentence_tag, keyword=keyword)
...
keyword = '' # str | 热点搜索词 (optional) (default to '')
    ...
    try:
        # 获取同城热点榜
        api_response = api_instance.fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get_0(page, page_size, order, city_code=city_code, sentence_tag=sentence_tag, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_city_list_api_v1_douyin_billboard_fetch_hot_city_list_get_0: %s\n" % e)
```
...
# **fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get**
> ResponseModel fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get(aweme_id)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取作品评论分析-词云权重
        api_response = api_instance.fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get: %s\n" % e)
```
...
# **fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get_0**
> ResponseModel fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get_0(aweme_id)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取作品评论分析-词云权重
        api_response = api_instance.fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get_0(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_comment_word_list_api_v1_douyin_billboard_fetch_hot_comment_word_list_get_0: %s\n" % e)
```
...
# **fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get**
> ResponseModel fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get(option, date_window, aweme_id=aweme_id)
...
date_window = 'date_window_example' # str | 时间窗口，1 按小时 2 按天
aweme_id = '' # str | 作品id (optional) (default to '')

    try:
        # 获取作品数据趋势
        api_response = api_instance.fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get(option, date_window, aweme_id=aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get: %s\n" % e)
```
...
# **fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get_0**
> ResponseModel fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get_0(option, date_window, aweme_id=aweme_id)
...
aweme_id = '' # str | 作品id (optional) (default to '')
    ...
    try:
        # 获取作品数据趋势
        api_response = api_instance.fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get_0(option, date_window, aweme_id=aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_item_trends_list_api_v1_douyin_billboard_fetch_hot_item_trends_list_get_0: %s\n" % e)
```
...
# **fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get**
> ResponseModel fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get(page, page_size, order, sentence_tag=sentence_tag, keyword=keyword)
...
keyword = '' # str | 热点搜索词 (optional) (default to '')
    ...
    try:
        # 获取上升热点榜
        api_response = api_instance.fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get(page, page_size, order, sentence_tag=sentence_tag, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get: %s\n" % e)
```
...
# **fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get_0**
> ResponseModel fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get_0(page, page_size, order, sentence_tag=sentence_tag, keyword=keyword)
...
keyword = '' # str | 热点搜索词 (optional) (default to '')
    ...
    try:
        # 获取上升热点榜
        api_response = api_instance.fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get_0(page, page_size, order, sentence_tag=sentence_tag, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_rise_list_api_v1_douyin_billboard_fetch_hot_rise_list_get_0: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取高涨粉率榜
        api_response = api_instance.fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post: %s\n" % e)
```
...
# **fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post_0**
> ResponseModel fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取高涨粉率榜
        api_response = api_instance.fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_fan_list_api_v1_douyin_billboard_fetch_hot_total_high_fan_list_post_0: %s\n" % e)
```
...
# **fetch_hot_total_high_like_list_api_v1_douyin_billboard_fetch_hot_total_high_like_list_post**
> ResponseModel fetch_hot_total_high_like_list_api_v1_douyin_billboard_fetch_hot_total_high_like_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取高点赞率榜
        api_response = api_instance.fetch_hot_total_high_like_list_api_v1_douyin_billboard_fetch_hot_total_high_like_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_like_list_api_v1_douyin_billboard_fetch_hot_total_high_like_list_post: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_high_like_list_api_v1_douyin_billboard_fetch_hot_total_high_like_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取高点赞率榜
        api_response = api_instance.fetch_hot_total_high_like_list_api_v1_douyin_billboard_fetch_hot_total_high_like_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_like_list_api_v1_douyin_billboard_fetch_hot_total_high_like_list_post_0: %s\n" % e)
```
...
# **fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post**
> ResponseModel fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取高完播率榜
        api_response = api_instance.fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取高完播率榜
        api_response = api_instance.fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_play_list_api_v1_douyin_billboard_fetch_hot_total_high_play_list_post_0: %s\n" % e)
```
...
# **fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post**
> ResponseModel fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取热度飙升的搜索榜
        api_response = api_instance.fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post: %s\n" % e)
```
...
# **fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post_0**
> ResponseModel fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取热度飙升的搜索榜
        api_response = api_instance.fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_search_list_api_v1_douyin_billboard_fetch_hot_total_high_search_list_post_0: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取热度飙升的话题榜
        api_response = api_instance.fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post: %s\n" % e)
```
...
# **fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post_0**
> ResponseModel fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取热度飙升的话题榜
        api_response = api_instance.fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_high_topic_list_api_v1_douyin_billboard_fetch_hot_total_high_topic_list_post_0: %s\n" % e)
```
...
# **fetch_hot_total_hot_word_detail_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_detail_list_get**
> ResponseModel fetch_hot_total_hot_word_detail_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_detail_list_get(keyword, word_id, query_day)
...
word_id = 'word_id_example' # str | 内容词id
query_day = 20250105 # int | 查询日期，格式为YYYYMMDD，需为当日

    try:
        # 获取内容词详情
        api_response = api_instance.fetch_hot_total_hot_word_detail_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_detail_list_get(keyword, word_id, query_day)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_hot_word_detail_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_detail_list_get: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_hot_word_detail_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_detail_list_get_0(keyword, word_id, query_day)
...
query_day = 20250105 # int | 查询日期，格式为YYYYMMDD，需为当日
    ...
    try:
        # 获取内容词详情
        api_response = api_instance.fetch_hot_total_hot_word_detail_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_detail_list_get_0(keyword, word_id, query_day)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_hot_word_detail_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_detail_list_get_0: %s\n" % e)
```
...
# **fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post**
> ResponseModel fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取全部内容词
        api_response = api_instance.fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post: %s\n" % e)
```
...
# **fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post_0**
> ResponseModel fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取全部内容词
        api_response = api_instance.fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_hot_word_list_api_v1_douyin_billboard_fetch_hot_total_hot_word_list_post_0: %s\n" % e)
```
...
# **fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get**
> ResponseModel fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get(page, page_size, type, snapshot_time=snapshot_time, start_date=start_date, end_date=end_date, sentence_tag=sentence_tag, keyword=keyword)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    page = 1 # int | 页码
page_size = 10 # int | 每页数量
type = 'type_example' # str | 快照类型 snapshot 按时刻查看 range 按时间范围
snapshot_time = '20250106151500' # str | 快照时间 格式yyyyMMddHHmmss (optional) (default to '20250106151500')
start_date = '' # str | 快照开始时间 格式yyyyMMdd (optional) (default to '')
end_date = '' # str | 快照结束时间 格式yyyyMMdd (optional) (default to '')
sentence_tag = '' # str | 热点分类标签，从热点榜分类获取，多个分类用逗号分隔，空为全部 (optional) (default to '')
keyword = '' # str | 热点搜索词 (optional) (default to '')
    ...
    try:
        # 获取热点总榜
        api_response = api_instance.fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get(page, page_size, type, snapshot_time=snapshot_time, start_date=start_date, end_date=end_date, sentence_tag=sentence_tag, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get: %s\n" % e)
```
 ...
 **page** | **int**| 页码 | 
 **page_size** | **int**| 每页数量 | 
 **type** | **str**| 快照类型 snapshot 按时刻查看 range 按时间范围 | 
 **snapshot_time** | **str**| 快照时间 格式yyyyMMddHHmmss | [optional] [default to &#39;20250106151500&#39;]
 **start_date** | **str**| 快照开始时间 格式yyyyMMdd | [optional] [default to &#39;&#39;]
 **end_date** | **str**| 快照结束时间 格式yyyyMMdd | [optional] [default to &#39;&#39;]
 **sentence_tag** | **str**| 热点分类标签，从热点榜分类获取，多个分类用逗号分隔，空为全部 | [optional] [default to &#39;&#39;]
...
# **fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get_0**
> ResponseModel fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get_0(page, page_size, type, snapshot_time=snapshot_time, start_date=start_date, end_date=end_date, sentence_tag=sentence_tag, keyword=keyword)
...
keyword = '' # str | 热点搜索词 (optional) (default to '')
    ...
    try:
        # 获取热点总榜
        api_response = api_instance.fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get_0(page, page_size, type, snapshot_time=snapshot_time, start_date=start_date, end_date=end_date, sentence_tag=sentence_tag, keyword=keyword)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_list_api_v1_douyin_billboard_fetch_hot_total_list_get_0: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_low_fan_list_api_v1_douyin_billboard_fetch_hot_total_low_fan_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取低粉爆款榜
        api_response = api_instance.fetch_hot_total_low_fan_list_api_v1_douyin_billboard_fetch_hot_total_low_fan_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_low_fan_list_api_v1_douyin_billboard_fetch_hot_total_low_fan_list_post: %s\n" % e)
```
...
# **fetch_hot_total_low_fan_list_api_v1_douyin_billboard_fetch_hot_total_low_fan_list_post_0**
> ResponseModel fetch_hot_total_low_fan_list_api_v1_douyin_billboard_fetch_hot_total_low_fan_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取低粉爆款榜
        api_response = api_instance.fetch_hot_total_low_fan_list_api_v1_douyin_billboard_fetch_hot_total_low_fan_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_low_fan_list_api_v1_douyin_billboard_fetch_hot_total_low_fan_list_post_0: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取搜索榜
        api_response = api_instance.fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post: %s\n" % e)
```
...
# **fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post_0**
> ResponseModel fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取搜索榜
        api_response = api_instance.fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_search_list_api_v1_douyin_billboard_fetch_hot_total_search_list_post_0: %s\n" % e)
```
...
# **fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post**
> ResponseModel fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取话题榜
        api_response = api_instance.fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post: %s\n" % e)
```
...
# **fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post_0**
> ResponseModel fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取话题榜
        api_response = api_instance.fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_topic_list_api_v1_douyin_billboard_fetch_hot_total_topic_list_post_0: %s\n" % e)
```
...
> ResponseModel fetch_hot_total_video_list_api_v1_douyin_billboard_fetch_hot_total_video_list_post(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取视频榜
        api_response = api_instance.fetch_hot_total_video_list_api_v1_douyin_billboard_fetch_hot_total_video_list_post(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_video_list_api_v1_douyin_billboard_fetch_hot_total_video_list_post: %s\n" % e)
```
...
# **fetch_hot_total_video_list_api_v1_douyin_billboard_fetch_hot_total_video_list_post_0**
> ResponseModel fetch_hot_total_video_list_api_v1_douyin_billboard_fetch_hot_total_video_list_post_0(unknown_base_type=unknown_base_type)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    try:
        # 获取视频榜
        api_response = api_instance.fetch_hot_total_video_list_api_v1_douyin_billboard_fetch_hot_total_video_list_post_0(unknown_base_type=unknown_base_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_total_video_list_api_v1_douyin_billboard_fetch_hot_total_video_list_post_0: %s\n" % e)
```
...
# **fetch_hot_user_portrait_list_api_v1_douyin_billboard_fetch_hot_user_portrait_list_get**
> ResponseModel fetch_hot_user_portrait_list_api_v1_douyin_billboard_fetch_hot_user_portrait_list_get(aweme_id, option)
...
with tikhub_sdk_v2.ApiClient() as api_client:
    ...
    api_instance = tikhub_sdk_v2.DouyinBillboardAPIApi(api_client)
    aweme_id = '7456035425539329340' # str | 作品id
option = 'option_example' # str | 选项，1 手机价格分布 2 性别分布 3 年龄分布 4 地域分布-省份 5 地域分布-城市 6 城市等级 7 手机品牌分布

    try:
        # 获取作品点赞观众画像-仅限热门榜
        api_response = api_instance.fetch_hot_user_portrait_list_api_v1_douyin_billboard_fetch_hot_user_portrait_list_get(aweme_id, option)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_user_portrait_list_api_v1_douyin_billboard_fetch_hot_user_portrait_list_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **aweme_id** | **str**| 作品id | 
 **option** | **str**| 选项，1 手机价格分布 2 性别分布 3 年龄分布 4 地域分布-省份 5 地域分布-城市 6 城市等级 7 手机品牌分布 | 
...
> ResponseModel fetch_hot_user_portrait_list_api_v1_douyin_billboard_fetch_hot_user_portrait_list_get_0(aweme_id, option)
...
option = 'option_example' # str | 选项，1 手机价格分布 2 性别分布 3 年龄分布 4 地域分布-省份 5 地域分布-城市 6 城市等级 7 手机品牌分布
    ...
    try:
        # 获取作品点赞观众画像-仅限热门榜
        api_response = api_instance.fetch_hot_user_portrait_list_api_v1_douyin_billboard_fetch_hot_user_portrait_list_get_0(aweme_id, option)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinBillboardAPIApi->fetch_hot_user_portrait_list_api_v1_douyin_billboard_fetch_hot_user_portrait_list_get_0: %s\n" % e)
```
