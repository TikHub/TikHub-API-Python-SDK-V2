...
[**fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get**](DouyinWebAPIApi.md#fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get) | **GET** /api/v1/douyin/web/fetch_douyin_web_guest_cookie | 获取抖音Web的游客Cookie/Get the guest Cookie of Douyin Web
...
[**fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get_0**](DouyinWebAPIApi.md#fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get_0) | **GET** /api/v1/douyin/web/fetch_live_search_result | 获取指定关键词的直播搜索结果/Get live search results of specified keywords
...
[**fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get_0**](DouyinWebAPIApi.md#fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get_0) | **GET** /api/v1/douyin/web/fetch_user_live_videos_by_room_id | 获取指定用户的直播流数据/Get live video data of specified user
...
[**fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get**](DouyinWebAPIApi.md#fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get) | **GET** /api/v1/douyin/web/fetch_user_search_result_v3 | 获取指定关键词的用户搜索结果V3/Get user search results of specified keywords V3
...
[**generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post_0**](DouyinWebAPIApi.md#generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post_0) | **POST** /api/v1/douyin/web/generate_a_bogus | 使用接口网址生成A-Bogus参数/Generate A-Bogus parameter using API URL
...
[**get_webcast_id_api_v1_douyin_web_get_webcast_id_get_0**](DouyinWebAPIApi.md#get_webcast_id_api_v1_douyin_web_get_webcast_id_get_0) | **GET** /api/v1/douyin/web/get_webcast_id | 提取直播间号/Extract webcast id
...
# **douyin_live_room_api_v1_douyin_web_douyin_live_room_get_0**
> ResponseModel douyin_live_room_api_v1_douyin_web_douyin_live_room_get_0(live_room_url, danmaku_type)
...
# **fetch_cartoon_aweme_api_v1_douyin_web_fetch_cartoon_aweme_get**
> ResponseModel fetch_cartoon_aweme_api_v1_douyin_web_fetch_cartoon_aweme_get(count, refresh_index=refresh_index, cookie=cookie)
...
# **fetch_cartoon_aweme_api_v1_douyin_web_fetch_food_aweme_get_0**
> ResponseModel fetch_cartoon_aweme_api_v1_douyin_web_fetch_food_aweme_get_0(count, refresh_index=refresh_index, cookie=cookie)
...
# **fetch_challenge_posts_api_v1_douyin_web_fetch_challenge_posts_post**
> ResponseModel fetch_challenge_posts_api_v1_douyin_web_fetch_challenge_posts_post(challenge_post_request=challenge_post_request)
...
# **fetch_city_hot_list_api_v1_douyin_web_fetch_city_hot_list_get_0**
> ResponseModel fetch_city_hot_list_api_v1_douyin_web_fetch_city_hot_list_get_0(page, page_size, sentence_tag, order, city_code)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 抖音城市列表/Douyin City List
        api_response = api_instance.fetch_city_list_api_v1_douyin_web_fetch_city_list_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_city_list_api_v1_douyin_web_fetch_city_list_get: %s\n" % e)
```
...
# **fetch_city_list_api_v1_douyin_web_fetch_city_list_get_0**
> ResponseModel fetch_city_list_api_v1_douyin_web_fetch_city_list_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 抖音城市列表/Douyin City List
        api_response = api_instance.fetch_city_list_api_v1_douyin_web_fetch_city_list_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_city_list_api_v1_douyin_web_fetch_city_list_get_0: %s\n" % e)
```
...
# **fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get**
> ResponseModel fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get(user_agent)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.212 Safari/537.36' # str | 用户浏览器代理/User browser agent

    try:
        # 获取抖音Web的游客Cookie/Get the guest Cookie of Douyin Web
        api_response = api_instance.fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get(user_agent)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get: %s\n" % e)
```
...
# **fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get_0**
> ResponseModel fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get_0(user_agent)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取抖音Web的游客Cookie/Get the guest Cookie of Douyin Web
        api_response = api_instance.fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get_0(user_agent)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_douyin_web_guest_cookie_api_v1_douyin_web_fetch_douyin_web_guest_cookie_get_0: %s\n" % e)
```
...
# **fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get**
> ResponseModel fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get(count, refresh_index=refresh_index, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户自行提供的Cookie/User provided Cookie (optional)
    ...
    try:
        # 游戏作品推荐/Knowledge Video
        api_response = api_instance.fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get(count, refresh_index=refresh_index, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get: %s\n" % e)
```
...
# **fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get_0**
> ResponseModel fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get_0(count, refresh_index=refresh_index, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户自行提供的Cookie/User provided Cookie (optional)
    ...
    try:
        # 游戏作品推荐/Knowledge Video
        api_response = api_instance.fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get_0(count, refresh_index=refresh_index, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_game_aweme_api_v1_douyin_web_fetch_game_aweme_get_0: %s\n" % e)
```
...
> ResponseModel fetch_general_search_result_api_v1_douyin_web_fetch_general_search_result_get(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_range=search_range, content_type=content_type, search_id=search_id)
...
sort_type = '0' # str | 排序类型/Sort type (optional) (default to '0')
publish_time = '0' # str | 发布时间/Publish time (optional) (default to '0')
filter_duration = '0' # str | 视频时长/Duration filter (optional) (default to '0')
search_range = '0' # str | 搜索范围/Search range (optional) (default to '0')
content_type = '0' # str | 内容类型/Content type (optional) (default to '0')
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')

    try:
        # 获取指定关键词的综合搜索结果/Get comprehensive search results of specified keywords
        api_response = api_instance.fetch_general_search_result_api_v1_douyin_web_fetch_general_search_result_get(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_range=search_range, content_type=content_type, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_general_search_result_api_v1_douyin_web_fetch_general_search_result_get: %s\n" % e)
```
 ...
 **filter_duration** | **str**| 视频时长/Duration filter | [optional] [default to &#39;0&#39;]
 **search_range** | **str**| 搜索范围/Search range | [optional] [default to &#39;0&#39;]
...
# **fetch_general_search_result_api_v1_douyin_web_fetch_general_search_result_get_0**
> ResponseModel fetch_general_search_result_api_v1_douyin_web_fetch_general_search_result_get_0(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_range=search_range, content_type=content_type, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的综合搜索结果/Get comprehensive search results of specified keywords
        api_response = api_instance.fetch_general_search_result_api_v1_douyin_web_fetch_general_search_result_get_0(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_range=search_range, content_type=content_type, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_general_search_result_api_v1_douyin_web_fetch_general_search_result_get_0: %s\n" % e)
```
...
> ResponseModel fetch_home_feed_api_v1_douyin_web_fetch_home_feed_get(count=count, refresh_index=refresh_index)
...
refresh_index = 0 # int | 翻页索引/Paging index (optional) (default to 0)

    try:
        # 获取首页推荐数据/Get home feed data
        api_response = api_instance.fetch_home_feed_api_v1_douyin_web_fetch_home_feed_get(count=count, refresh_index=refresh_index)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_home_feed_api_v1_douyin_web_fetch_home_feed_get: %s\n" % e)
```
 ...
 **refresh_index** | **int**| 翻页索引/Paging index | [optional] [default to 0]
...
# **fetch_home_feed_api_v1_douyin_web_fetch_home_feed_get_0**
> ResponseModel fetch_home_feed_api_v1_douyin_web_fetch_home_feed_get_0(count=count, refresh_index=refresh_index)
...
refresh_index = 0 # int | 翻页索引/Paging index (optional) (default to 0)
    ...
    try:
        # 获取首页推荐数据/Get home feed data
        api_response = api_instance.fetch_home_feed_api_v1_douyin_web_fetch_home_feed_get_0(count=count, refresh_index=refresh_index)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_home_feed_api_v1_douyin_web_fetch_home_feed_get_0: %s\n" % e)
```
...
# **fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get**
> ResponseModel fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get(page, page_size, sentence_tag)
...
sentence_tag = 'sentence_tag_example' # str | 分类标签/Category tag
    ...
    try:
        # 抖音热点总榜单/Douyin Hot List
        api_response = api_instance.fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get(page, page_size, sentence_tag)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get: %s\n" % e)
```
...
# **fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get_0**
> ResponseModel fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get_0(page, page_size, sentence_tag)
...
sentence_tag = 'sentence_tag_example' # str | 分类标签/Category tag
    ...
    try:
        # 抖音热点总榜单/Douyin Hot List
        api_response = api_instance.fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get_0(page, page_size, sentence_tag)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_hot_list_api_v1_douyin_web_fetch_hot_list_get_0: %s\n" % e)
```
...
# **fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get**
> ResponseModel fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取抖音热榜数据/Get Douyin hot search results
        api_response = api_instance.fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get: %s\n" % e)
```
...
# **fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get_0**
> ResponseModel fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取抖音热榜数据/Get Douyin hot search results
        api_response = api_instance.fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_hot_search_result_api_v1_douyin_web_fetch_hot_search_result_get_0: %s\n" % e)
```
...
# **fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get**
> ResponseModel fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get(count, refresh_index=refresh_index, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户自行提供的Cookie/User provided Cookie (optional)
    ...
    try:
        # 知识作品推荐/Knowledge Video
        api_response = api_instance.fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get(count, refresh_index=refresh_index, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get: %s\n" % e)
```
...
# **fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get_0**
> ResponseModel fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get_0(count, refresh_index=refresh_index, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户自行提供的Cookie/User provided Cookie (optional)
    ...
    try:
        # 知识作品推荐/Knowledge Video
        api_response = api_instance.fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get_0(count, refresh_index=refresh_index, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_knowledge_aweme_api_v1_douyin_web_fetch_knowledge_aweme_get_0: %s\n" % e)
```
...
# **fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get**
> ResponseModel fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get(room_id, rank_type=rank_type)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    room_id = '7356585666190461731' # str | 直播间room_id/Room room_id
rank_type = 30 # int | 排行类型/Leaderboard type (optional) (default to 30)

    try:
        # 获取直播间送礼用户排行榜/Get live room gift user ranking
        api_response = api_instance.fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get(room_id, rank_type=rank_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get: %s\n" % e)
```
 ...
 **rank_type** | **int**| 排行类型/Leaderboard type | [optional] [default to 30]
...
# **fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get_0**
> ResponseModel fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get_0(room_id, rank_type=rank_type)
...
rank_type = 30 # int | 排行类型/Leaderboard type (optional) (default to 30)
    ...
    try:
        # 获取直播间送礼用户排行榜/Get live room gift user ranking
        api_response = api_instance.fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get_0(room_id, rank_type=rank_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_live_gift_ranking_api_v1_douyin_web_fetch_live_gift_ranking_get_0: %s\n" % e)
```
...
# **fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get**
> ResponseModel fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get(room_id, author_id, limit=limit)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    room_id = '7360830184578091776' # str | 直播间room_id/Room room_id
author_id = '1714858898241277' # str | 作者id/Author id
limit = 20 # int | 数量/Number (optional) (default to 20)

    try:
        # 抖音直播间商品信息/Douyin live room product information
        api_response = api_instance.fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get(room_id, author_id, limit=limit)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get: %s\n" % e)
```
 ...
 **limit** | **int**| 数量/Number | [optional] [default to 20]
...
# **fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get_0**
> ResponseModel fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get_0(room_id, author_id, limit=limit)
...
limit = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 抖音直播间商品信息/Douyin live room product information
        api_response = api_instance.fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get_0(room_id, author_id, limit=limit)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_live_room_product_result_api_v1_douyin_web_fetch_live_room_product_result_get_0: %s\n" % e)
```
...
# **fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get**
> ResponseModel fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get(keyword, offset=offset, count=count, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的直播搜索结果/Get live search results of specified keywords
        api_response = api_instance.fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get(keyword, offset=offset, count=count, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get: %s\n" % e)
```
...
# **fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get_0**
> ResponseModel fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get_0(keyword, offset=offset, count=count, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的直播搜索结果/Get live search results of specified keywords
        api_response = api_instance.fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get_0(keyword, offset=offset, count=count, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_live_search_result_api_v1_douyin_web_fetch_live_search_result_get_0: %s\n" % e)
```
...
# **fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post**
> ResponseModel fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 批量获取视频信息/Batch Get Video Information
        api_response = api_instance.fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post: %s\n" % e)
```
...
# **fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post_0**
> ResponseModel fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 批量获取视频信息/Batch Get Video Information
        api_response = api_instance.fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_multi_video_api_v1_douyin_web_fetch_multi_video_post_0: %s\n" % e)
```
...
# **fetch_one_video_api_v1_douyin_web_fetch_one_video_get**
> ResponseModel fetch_one_video_api_v1_douyin_web_fetch_one_video_get(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据，此接口即将废弃，请使用APP接口/Get single video data, this endpoint will be deprecated soon, please use APP endpoint
        api_response = api_instance.fetch_one_video_api_v1_douyin_web_fetch_one_video_get(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_api_v1_douyin_web_fetch_one_video_get: %s\n" % e)
```
...
# **fetch_one_video_api_v1_douyin_web_fetch_one_video_get_0**
> ResponseModel fetch_one_video_api_v1_douyin_web_fetch_one_video_get_0(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据，此接口即将废弃，请使用APP接口/Get single video data, this endpoint will be deprecated soon, please use APP endpoint
        api_response = api_instance.fetch_one_video_api_v1_douyin_web_fetch_one_video_get_0(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_api_v1_douyin_web_fetch_one_video_get_0: %s\n" % e)
```
...
# **fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get**
> ResponseModel fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据 V2/Get single video data V2
        api_response = api_instance.fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get: %s\n" % e)
```
...
# **fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get_0**
> ResponseModel fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get_0(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取单个作品数据 V2/Get single video data V2
        api_response = api_instance.fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get_0(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_api_v1_douyin_web_fetch_one_video_v2_get_0: %s\n" % e)
```
...
# **fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get**
> ResponseModel fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get(share_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据分享链接获取单个作品数据/Get single video data by sharing link
        api_response = api_instance.fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get(share_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get: %s\n" % e)
```
...
# **fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get_0**
> ResponseModel fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get_0(share_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据分享链接获取单个作品数据/Get single video data by sharing link
        api_response = api_instance.fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get_0(share_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_by_share_url_api_v1_douyin_web_fetch_one_video_by_share_url_get_0: %s\n" % e)
```
...
> ResponseModel fetch_one_video_danmaku_api_v1_douyin_web_fetch_one_video_danmaku_get(item_id, duration, end_time, start_time)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    item_id = '7355433624046472498' # str | 作品id/Video id
duration = 15134 # int | 视频总时长/Video total duration
end_time = 15133 # int | 结束时间/End time
start_time = 56 # int | 开始时间/Start time

    try:
        # 获取单个作品视频弹幕数据/Get single video danmaku data
        api_response = api_instance.fetch_one_video_danmaku_api_v1_douyin_web_fetch_one_video_danmaku_get(item_id, duration, end_time, start_time)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_danmaku_api_v1_douyin_web_fetch_one_video_danmaku_get: %s\n" % e)
```
...
# **fetch_one_video_danmaku_api_v1_douyin_web_fetch_one_video_danmaku_get_0**
> ResponseModel fetch_one_video_danmaku_api_v1_douyin_web_fetch_one_video_danmaku_get_0(item_id, duration, end_time, start_time)
...
start_time = 56 # int | 开始时间/Start time
    ...
    try:
        # 获取单个作品视频弹幕数据/Get single video danmaku data
        api_response = api_instance.fetch_one_video_danmaku_api_v1_douyin_web_fetch_one_video_danmaku_get_0(item_id, duration, end_time, start_time)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_one_video_danmaku_api_v1_douyin_web_fetch_one_video_danmaku_get_0: %s\n" % e)
```
...
# **fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get**
> ResponseModel fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get(page, page_size)
...
page_size = 10 # int | 每页数量/Number per page
    ...
    try:
        # 抖音实时挑战榜单/Douyin Real-time Challenge List
        api_response = api_instance.fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get(page, page_size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get: %s\n" % e)
```
...
# **fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get_0**
> ResponseModel fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get_0(page, page_size)
...
page_size = 10 # int | 每页数量/Number per page
    ...
    try:
        # 抖音实时挑战榜单/Douyin Real-time Challenge List
        api_response = api_instance.fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get_0(page, page_size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_real_time_challenge_list_api_v1_douyin_web_fetch_real_time_challenge_list_get_0: %s\n" % e)
```
...
# **fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get**
> ResponseModel fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get(page, page_size, sentence_tag, order)
...
order = 'rank' # str | 排序方式/Sorting method
    ...
    try:
        # 抖音实时上升热点榜/Douyin Real-time Rising Hot List
        api_response = api_instance.fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get(page, page_size, sentence_tag, order)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get: %s\n" % e)
```
...
# **fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get_0**
> ResponseModel fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get_0(page, page_size, sentence_tag, order)
...
order = 'rank' # str | 排序方式/Sorting method
    ...
    try:
        # 抖音实时上升热点榜/Douyin Real-time Rising Hot List
        api_response = api_instance.fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get_0(page, page_size, sentence_tag, order)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_real_time_rising_hot_list_api_v1_douyin_web_fetch_real_time_rising_hot_list_get_0: %s\n" % e)
```
...
# **fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get**
> ResponseModel fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get(aweme_id, refresh_index=refresh_index, count=count)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    aweme_id = '7393365489105358132' # str | 作品id/Video id
refresh_index = 1 # int | 翻页索引/Paging index (optional) (default to 1)
count = 20 # int | 数量/Number (optional) (default to 20)

    try:
        # 获取相关作品推荐数据/Get related posts recommendation data
        api_response = api_instance.fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get(aweme_id, refresh_index=refresh_index, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get: %s\n" % e)
```
...
# **fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get_0**
> ResponseModel fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get_0(aweme_id, refresh_index=refresh_index, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取相关作品推荐数据/Get related posts recommendation data
        api_response = api_instance.fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get_0(aweme_id, refresh_index=refresh_index, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_related_posts_api_v1_douyin_web_fetch_related_posts_get_0: %s\n" % e)
```
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    search_challenge_request = tikhub_sdk_v2.SearchChallengeRequest() # SearchChallengeRequest |  (optional)

    try:
        # 搜索话题/Search Challenge
        api_response = api_instance.fetch_search_challenge_api_v1_douyin_web_fetch_search_challenge_post(search_challenge_request=search_challenge_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_search_challenge_api_v1_douyin_web_fetch_search_challenge_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **search_challenge_request** | [**SearchChallengeRequest**](SearchChallengeRequest.md)|  | [optional] 
...
# **fetch_search_challenge_api_v1_douyin_web_fetch_search_challenge_post_0**
> ResponseModel fetch_search_challenge_api_v1_douyin_web_fetch_search_challenge_post_0(search_challenge_request=search_challenge_request)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 搜索话题/Search Challenge
        api_response = api_instance.fetch_search_challenge_api_v1_douyin_web_fetch_search_challenge_post_0(search_challenge_request=search_challenge_request)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_search_challenge_api_v1_douyin_web_fetch_search_challenge_post_0: %s\n" % e)
```
...
# **fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get**
> ResponseModel fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get(offset, count, content_type, cookie=cookie)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    offset = 56 # int | 页码/Page number
count = 16 # int | 每页数量/Number per page
content_type = 56 # int | 短剧类型/Subtype
cookie = 'cookie_example' # str | 用户自行提供的Cookie/User provided Cookie (optional)

    try:
        # 短剧作品/Series Video
        api_response = api_instance.fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get(offset, count, content_type, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get: %s\n" % e)
```
...
# **fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get_0**
> ResponseModel fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get_0(offset, count, content_type, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户自行提供的Cookie/User provided Cookie (optional)
    ...
    try:
        # 短剧作品/Series Video
        api_response = api_instance.fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get_0(offset, count, content_type, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_series_aweme_api_v1_douyin_web_fetch_series_aweme_get_0: %s\n" % e)
```
...
# **fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get**
> ResponseModel fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get(cookie, max_cursor=max_cursor, counts=counts)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    cookie = 'YOUR_COOKIE' # str | 用户网页版抖音Cookie/Your web version of Douyin Cookie
max_cursor = 0 # int | 最大游标/Maximum cursor (optional) (default to 0)
counts = 20 # int | 每页数量/Number per page (optional) (default to 20)

    try:
        # 获取用户收藏作品数据/Get user collection video data
        api_response = api_instance.fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get(cookie, max_cursor=max_cursor, counts=counts)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get: %s\n" % e)
```
...
# **fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get_0**
> ResponseModel fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get_0(cookie, max_cursor=max_cursor, counts=counts)
...
counts = 20 # int | 每页数量/Number per page (optional) (default to 20)
    ...
    try:
        # 获取用户收藏作品数据/Get user collection video data
        api_response = api_instance.fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get_0(cookie, max_cursor=max_cursor, counts=counts)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_collection_videos_api_v1_douyin_web_fetch_user_collection_videos_get_0: %s\n" % e)
```
...
# **fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get**
> ResponseModel fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get(sec_uid, interest_type)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    sec_uid = 'MS4wLjABAAAAeYieCW7Pj5O1UK9slPzMKdZdPZaALVzuovX2T2wxwffeuBO1P1pw6xS6TgH0kRpL' # str | 用户sec_uid/Sec_uid of user
interest_type = 'search' # str | 兴趣类型/Interest type

    try:
        # 抖音用户粉丝兴趣/Douyin User Fans Interest
        api_response = api_instance.fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get(sec_uid, interest_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sec_uid** | **str**| 用户sec_uid/Sec_uid of user | 
 **interest_type** | **str**| 兴趣类型/Interest type | 
...
# **fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get_0**
> ResponseModel fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get_0(sec_uid, interest_type)
...
interest_type = 'search' # str | 兴趣类型/Interest type
    ...
    try:
        # 抖音用户粉丝兴趣/Douyin User Fans Interest
        api_response = api_instance.fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get_0(sec_uid, interest_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_fans_interest_api_v1_douyin_web_fetch_user_fans_interest_get_0: %s\n" % e)
```
...
# **fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get**
> ResponseModel fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    sec_user_id = 'MS4wLjABAAAA9y04iBlVdeMQqTJbqsQZKb-tqWqWW29jPVJqideHT70' # str | 用户sec_user_id/User sec_user_id (optional) (default to 'MS4wLjABAAAA9y04iBlVdeMQqTJbqsQZKb-tqWqWW29jPVJqideHT70')
max_time = '0' # str | 最大时间戳/Maximum timestamp (optional) (default to '0')
count = 20 # int | 数量/Number (optional) (default to 20)
source_type = 1 # int | 来源类型/Source type (optional) (default to 1)

    try:
        # 获取用户粉丝列表/Get user fans list
        api_response = api_instance.fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sec_user_id** | **str**| 用户sec_user_id/User sec_user_id | [optional] [default to &#39;MS4wLjABAAAA9y04iBlVdeMQqTJbqsQZKb-tqWqWW29jPVJqideHT70&#39;]
 **max_time** | **str**| 最大时间戳/Maximum timestamp | [optional] [default to &#39;0&#39;]
 **count** | **int**| 数量/Number | [optional] [default to 20]
 **source_type** | **int**| 来源类型/Source type | [optional] [default to 1]
...
# **fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get_0**
> ResponseModel fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
...
source_type = 1 # int | 来源类型/Source type (optional) (default to 1)
    ...
    try:
        # 获取用户粉丝列表/Get user fans list
        api_response = api_instance.fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_fans_list_api_v1_douyin_web_fetch_user_fans_list_get_0: %s\n" % e)
```
...
# **fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get**
> ResponseModel fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get(sec_uid, option=option)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    sec_uid = 'MS4wLjABAAAAeYieCW7Pj5O1UK9slPzMKdZdPZaALVzuovX2T2wxwffeuBO1P1pw6xS6TgH0kRpL' # str | 用户sec_uid/Sec_uid of user
option = '1' # str | 选项/Option (optional) (default to '1')

    try:
        # 抖音用户粉丝画像/Douyin User Fans Portrait
        api_response = api_instance.fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get(sec_uid, option=option)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **sec_uid** | **str**| 用户sec_uid/Sec_uid of user | 
 **option** | **str**| 选项/Option | [optional] [default to &#39;1&#39;]
...
# **fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get_0**
> ResponseModel fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get_0(sec_uid, option=option)
...
option = '1' # str | 选项/Option (optional) (default to '1')
    ...
    try:
        # 抖音用户粉丝画像/Douyin User Fans Portrait
        api_response = api_instance.fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get_0(sec_uid, option=option)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_fans_portrait_api_v1_douyin_web_fetch_user_fans_portrait_get_0: %s\n" % e)
```
...
# **fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get**
> ResponseModel fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
...
source_type = 1 # int | 来源类型/Source type (optional) (default to 1)
    ...
    try:
        # 获取用户关注列表/Get user following list
        api_response = api_instance.fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get: %s\n" % e)
```
...
# **fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get_0**
> ResponseModel fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
...
source_type = 1 # int | 来源类型/Source type (optional) (default to 1)
    ...
    try:
        # 获取用户关注列表/Get user following list
        api_response = api_instance.fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get_0(sec_user_id=sec_user_id, max_time=max_time, count=count, source_type=source_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_following_list_api_v1_douyin_web_fetch_user_following_list_get_0: %s\n" % e)
```
...
# **fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get**
> ResponseModel fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get(sec_user_id, max_cursor=max_cursor, counts=counts, cookie=cookie)
...
max_cursor = 0 # int | 最大游标/Maximum cursor (optional) (default to 0)
counts = 20 # int | 每页数量/Number per page (optional) (default to 20)
cookie = 'cookie_example' # str | 用户网页版抖音Cookie/Your web version of Douyin Cookie (optional)

    try:
        # 获取用户喜欢作品数据/Get user like video data
        api_response = api_instance.fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get(sec_user_id, max_cursor=max_cursor, counts=counts, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get: %s\n" % e)
```
 ...
 **max_cursor** | **int**| 最大游标/Maximum cursor | [optional] [default to 0]
 **counts** | **int**| 每页数量/Number per page | [optional] [default to 20]
 **cookie** | **str**| 用户网页版抖音Cookie/Your web version of Douyin Cookie | [optional] 
...
# **fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get_0**
> ResponseModel fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get_0(sec_user_id, max_cursor=max_cursor, counts=counts, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户网页版抖音Cookie/Your web version of Douyin Cookie (optional)
    ...
    try:
        # 获取用户喜欢作品数据/Get user like video data
        api_response = api_instance.fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get_0(sec_user_id, max_cursor=max_cursor, counts=counts, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_like_videos_api_v1_douyin_web_fetch_user_like_videos_get_0: %s\n" % e)
```
...
# **fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get**
> ResponseModel fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get(uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    uid = '3081254195702747' # str | 用户UID/User UID

    try:
        # 使用UID获取用户开播信息/Get user live information by UID
        api_response = api_instance.fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get(uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get: %s\n" % e)
```
...
# **fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get_0**
> ResponseModel fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get_0(uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 使用UID获取用户开播信息/Get user live information by UID
        api_response = api_instance.fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get_0(uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_info_by_uid_api_v1_douyin_web_fetch_user_live_info_by_uid_get_0: %s\n" % e)
```
...
# **fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get**
> ResponseModel fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get(webcast_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    webcast_id = '376034101029' # str | 直播间webcast_id/Room webcast_id

    try:
        # 获取用户直播流数据/Get user live video data
        api_response = api_instance.fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get(webcast_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get: %s\n" % e)
```
...
# **fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get_0**
> ResponseModel fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get_0(webcast_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取用户直播流数据/Get user live video data
        api_response = api_instance.fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get_0(webcast_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_api_v1_douyin_web_fetch_user_live_videos_get_0: %s\n" % e)
```
...
# **fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get**
> ResponseModel fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get(room_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    room_id = '7318296342189919011' # str | 直播间room_id/Room room_id

    try:
        # 获取指定用户的直播流数据/Get live video data of specified user
        api_response = api_instance.fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get(room_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get: %s\n" % e)
```
...
# **fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get_0**
> ResponseModel fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get_0(room_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取指定用户的直播流数据/Get live video data of specified user
        api_response = api_instance.fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get_0(room_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_by_room_id_api_v1_douyin_web_fetch_user_live_videos_by_room_id_get_0: %s\n" % e)
```
...
# **fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get**
> ResponseModel fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get(room_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    room_id = '7462723839303093032' # str | 直播间room_id/Room room_id

    try:
        # 获取指定用户的直播流数据V2/Gets the live stream data of the specified user V2
        api_response = api_instance.fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get(room_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get: %s\n" % e)
```
...
# **fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get_0**
> ResponseModel fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get_0(room_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取指定用户的直播流数据V2/Gets the live stream data of the specified user V2
        api_response = api_instance.fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get_0(room_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_by_room_id_v2_api_v1_douyin_web_fetch_user_live_videos_by_room_id_v2_get_0: %s\n" % e)
```
...
# **fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get**
> ResponseModel fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get(sec_uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    sec_uid = 'MS4wLjABAAAAAIKOBr_x6p2fPVKOAhqG8LrC1lwwdWChifKEsl-TXFS-kGSGqpMBRexJdzoAfvUF' # str | 用户sec_uid/User sec_uid

    try:
        # 通过sec_uid获取指定用户的直播流数据/Get live video data of specified user by sec_uid
        api_response = api_instance.fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get(sec_uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get: %s\n" % e)
```
...
# **fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get_0**
> ResponseModel fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get_0(sec_uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 通过sec_uid获取指定用户的直播流数据/Get live video data of specified user by sec_uid
        api_response = api_instance.fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get_0(sec_uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_live_videos_by_sec_uid_api_v1_douyin_web_fetch_user_live_videos_by_sec_uid_get_0: %s\n" % e)
```
...
# **fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get**
> ResponseModel fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get(mix_id, max_cursor=max_cursor, counts=counts)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    mix_id = '7348687990509553679' # str | 合辑id/Mix id
max_cursor = 0 # int | 最大游标/Maximum cursor (optional) (default to 0)
counts = 20 # int | 每页数量/Number per page (optional) (default to 20)

    try:
        # 获取用户合辑作品数据/Get user mix video data
        api_response = api_instance.fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get(mix_id, max_cursor=max_cursor, counts=counts)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get: %s\n" % e)
```
...
# **fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get_0**
> ResponseModel fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get_0(mix_id, max_cursor=max_cursor, counts=counts)
...
counts = 20 # int | 每页数量/Number per page (optional) (default to 20)
    ...
    try:
        # 获取用户合辑作品数据/Get user mix video data
        api_response = api_instance.fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get_0(mix_id, max_cursor=max_cursor, counts=counts)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_mix_videos_api_v1_douyin_web_fetch_user_mix_videos_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_post_videos_api_v1_douyin_web_fetch_user_post_videos_get(sec_user_id, max_cursor=max_cursor, count=count, filter_type=filter_type, cookie=cookie)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    sec_user_id = 'MS4wLjABAAAANXSltcLCzDGmdNFI2Q_QixVTr67NiYzjKOIP5s03CAE' # str | 用户sec_user_id/User sec_user_id
max_cursor = '0' # str | 最大游标/Maximum cursor (optional) (default to '0')
count = 20 # int | 每页数量/Number per page (optional) (default to 20)
filter_type = '0' # str | 过滤类型/Filter type (optional) (default to '0')
cookie = 'cookie_example' # str | 用户网页版抖音Cookie/Your web version of Douyin Cookie (optional)

    try:
        # 获取用户主页作品数据/Get user homepage video data
        api_response = api_instance.fetch_user_post_videos_api_v1_douyin_web_fetch_user_post_videos_get(sec_user_id, max_cursor=max_cursor, count=count, filter_type=filter_type, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_post_videos_api_v1_douyin_web_fetch_user_post_videos_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **sec_user_id** | **str**| 用户sec_user_id/User sec_user_id | 
 **max_cursor** | **str**| 最大游标/Maximum cursor | [optional] [default to &#39;0&#39;]
 **count** | **int**| 每页数量/Number per page | [optional] [default to 20]
 **filter_type** | **str**| 过滤类型/Filter type | [optional] [default to &#39;0&#39;]
 **cookie** | **str**| 用户网页版抖音Cookie/Your web version of Douyin Cookie | [optional] 
...
# **fetch_user_post_videos_api_v1_douyin_web_fetch_user_post_videos_get_0**
> ResponseModel fetch_user_post_videos_api_v1_douyin_web_fetch_user_post_videos_get_0(sec_user_id, max_cursor=max_cursor, count=count, filter_type=filter_type, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户网页版抖音Cookie/Your web version of Douyin Cookie (optional)
    ...
    try:
        # 获取用户主页作品数据/Get user homepage video data
        api_response = api_instance.fetch_user_post_videos_api_v1_douyin_web_fetch_user_post_videos_get_0(sec_user_id, max_cursor=max_cursor, count=count, filter_type=filter_type, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_post_videos_api_v1_douyin_web_fetch_user_post_videos_get_0: %s\n" % e)
```
...
# **fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get**
> ResponseModel fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get(short_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    short_id = '114131058' # str | 用户Short ID/User Short ID

    try:
        # 使用Short ID获取用户信息/Get user information by Short ID
        api_response = api_instance.fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get(short_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get: %s\n" % e)
```
...
# **fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get_0**
> ResponseModel fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get_0(short_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 使用Short ID获取用户信息/Get user information by Short ID
        api_response = api_instance.fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get_0(short_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_profile_by_short_id_api_v1_douyin_web_fetch_user_profile_by_short_id_get_0: %s\n" % e)
```
...
# **fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get**
> ResponseModel fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get(uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    uid = '68141954464' # str | 用户UID/User UID

    try:
        # 使用UID获取用户信息/Get user information by UID
        api_response = api_instance.fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get(uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get: %s\n" % e)
```
...
# **fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get_0**
> ResponseModel fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get_0(uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 使用UID获取用户信息/Get user information by UID
        api_response = api_instance.fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get_0(uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_profile_by_uid_api_v1_douyin_web_fetch_user_profile_by_uid_get_0: %s\n" % e)
```
...
# **fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get**
> ResponseModel fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type, search_id=search_id)
...
offset = 0 # int | 偏移量/Offset (optional) (default to 0)
count = 20 # int | 数量/Number (optional) (default to 20)
douyin_user_fans = '' # str | 粉丝数/Fans (optional) (default to '')
douyin_user_type = '' # str | 用户类型/User type (optional) (default to '')
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')

    try:
        # 获取指定关键词的用户搜索结果(已废弃，使用V2或V3接口代替)/Get user search results of specified keywords (deprecated, use V2 or V3 interface instead)
        api_response = api_instance.fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get: %s\n" % e)
```
...
# **fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get_0**
> ResponseModel fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get_0(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的用户搜索结果(已废弃，使用V2或V3接口代替)/Get user search results of specified keywords (deprecated, use V2 or V3 interface instead)
        api_response = api_instance.fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get_0(keyword, offset=offset, count=count, douyin_user_fans=douyin_user_fans, douyin_user_type=douyin_user_type, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_search_result_api_v1_douyin_web_fetch_user_search_result_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_search_result_v2_api_v1_douyin_web_fetch_user_search_result_v2_get(keyword, cursor=cursor)
...
cursor = 0 # int | 游标/Cursor (optional) (default to 0)
    ...
    try:
        # 获取指定关键词的用户搜索结果V2/Get user search results of specified keywords V2
        api_response = api_instance.fetch_user_search_result_v2_api_v1_douyin_web_fetch_user_search_result_v2_get(keyword, cursor=cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_search_result_v2_api_v1_douyin_web_fetch_user_search_result_v2_get: %s\n" % e)
```
...
# **fetch_user_search_result_v2_api_v1_douyin_web_fetch_user_search_result_v2_get_0**
> ResponseModel fetch_user_search_result_v2_api_v1_douyin_web_fetch_user_search_result_v2_get_0(keyword, cursor=cursor)
...
cursor = 0 # int | 游标/Cursor (optional) (default to 0)
    ...
    try:
        # 获取指定关键词的用户搜索结果V2/Get user search results of specified keywords V2
        api_response = api_instance.fetch_user_search_result_v2_api_v1_douyin_web_fetch_user_search_result_v2_get_0(keyword, cursor=cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_search_result_v2_api_v1_douyin_web_fetch_user_search_result_v2_get_0: %s\n" % e)
```
...
# **fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get**
> ResponseModel fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get(keyword, cursor=cursor, douyin_user_type=douyin_user_type, douyin_user_fans=douyin_user_fans)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    keyword = '中华娘' # str | 关键词/Keyword
cursor = '0' # str | 游标/Cursor (optional) (default to '0')
douyin_user_type = '' # str | 用户类型/User type (optional) (default to '')
douyin_user_fans = '' # str | 粉丝数/Fans (optional) (default to '')

    try:
        # 获取指定关键词的用户搜索结果V3/Get user search results of specified keywords V3
        api_response = api_instance.fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get(keyword, cursor=cursor, douyin_user_type=douyin_user_type, douyin_user_fans=douyin_user_fans)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **keyword** | **str**| 关键词/Keyword | 
 **cursor** | **str**| 游标/Cursor | [optional] [default to &#39;0&#39;]
 **douyin_user_type** | **str**| 用户类型/User type | [optional] [default to &#39;&#39;]
 **douyin_user_fans** | **str**| 粉丝数/Fans | [optional] [default to &#39;&#39;]
...
# **fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get_0**
> ResponseModel fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get_0(keyword, cursor=cursor, douyin_user_type=douyin_user_type, douyin_user_fans=douyin_user_fans)
...
douyin_user_fans = '' # str | 粉丝数/Fans (optional) (default to '')
    ...
    try:
        # 获取指定关键词的用户搜索结果V3/Get user search results of specified keywords V3
        api_response = api_instance.fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get_0(keyword, cursor=cursor, douyin_user_type=douyin_user_type, douyin_user_fans=douyin_user_fans)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_user_search_result_v3_api_v1_douyin_web_fetch_user_search_result_v3_get_0: %s\n" % e)
```
...
# **fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get**
> ResponseModel fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get(date, page, page_size, sub_type)
...
page = 1 # int | 页码/Page number
page_size = 10 # int | 每页数量/Number per page
sub_type = 1001 # int | 子类型/Subtype

    try:
        # 抖音视频榜单/Douyin Video Billboard
        api_response = api_instance.fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get(date, page, page_size, sub_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get: %s\n" % e)
```
...
# **fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get_0**
> ResponseModel fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get_0(date, page, page_size, sub_type)
...
sub_type = 1001 # int | 子类型/Subtype
    ...
    try:
        # 抖音视频榜单/Douyin Video Billboard
        api_response = api_instance.fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get_0(date, page, page_size, sub_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_billboard_api_v1_douyin_web_fetch_video_billboard_get_0: %s\n" % e)
```
...
# **fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get**
> ResponseModel fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get(tag_id, count=count, refresh_index=refresh_index)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    tag_id = 300203 # int | 标签id/Tag id
count = 10 # int | 数量/Number (optional) (default to 10)
refresh_index = 1 # int | 刷新索引/Refresh index (optional) (default to 1)

    try:
        # 抖音视频频道数据/Douyin video channel data
        api_response = api_instance.fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get(tag_id, count=count, refresh_index=refresh_index)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get: %s\n" % e)
```
 ...
 **count** | **int**| 数量/Number | [optional] [default to 10]
 **refresh_index** | **int**| 刷新索引/Refresh index | [optional] [default to 1]
...
# **fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get_0**
> ResponseModel fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get_0(tag_id, count=count, refresh_index=refresh_index)
...
refresh_index = 1 # int | 刷新索引/Refresh index (optional) (default to 1)
    ...
    try:
        # 抖音视频频道数据/Douyin video channel data
        api_response = api_instance.fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get_0(tag_id, count=count, refresh_index=refresh_index)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_channel_result_api_v1_douyin_web_fetch_video_channel_result_get_0: %s\n" % e)
```
...
# **fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get**
> ResponseModel fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get(aweme_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取单个视频评论数据/Get single video comments data
        api_response = api_instance.fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get(aweme_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get: %s\n" % e)
```
...
# **fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get_0**
> ResponseModel fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get_0(aweme_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取单个视频评论数据/Get single video comments data
        api_response = api_instance.fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get_0(aweme_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_comments_api_v1_douyin_web_fetch_video_comments_get_0: %s\n" % e)
```
...
# **fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get**
> ResponseModel fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get(item_id, comment_id, cursor=cursor, count=count)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    item_id = '7354666303006723354' # str | 作品id/Video id
comment_id = '7354669356632638218' # str | 评论id/Comment id
cursor = 0 # int | 游标/Cursor (optional) (default to 0)
count = 20 # int | 数量/Number (optional) (default to 20)

    try:
        # 获取指定视频的评论回复数据/Get comment replies data of specified video
        api_response = api_instance.fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get(item_id, comment_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get: %s\n" % e)
```
...
# **fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get_0**
> ResponseModel fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get_0(item_id, comment_id, cursor=cursor, count=count)
...
count = 20 # int | 数量/Number (optional) (default to 20)
    ...
    try:
        # 获取指定视频的评论回复数据/Get comment replies data of specified video
        api_response = api_instance.fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get_0(item_id, comment_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_comments_reply_api_v1_douyin_web_fetch_video_comment_replies_get_0: %s\n" % e)
```
...
# **fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get**
> ResponseModel fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    aweme_id = '7429296623961853234' # str | 作品id/Video id

    try:
        # 获取视频新增粉丝数量/Get video new fans count
        api_response = api_instance.fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get: %s\n" % e)
```
...
# **fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get_0**
> ResponseModel fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get_0(aweme_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取视频新增粉丝数量/Get video new fans count
        api_response = api_instance.fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get_0(aweme_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_fans_add_count_api_v1_douyin_web_fetch_video_fans_add_count_get_0: %s\n" % e)
```
...
# **fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get**
> ResponseModel fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get(aweme_id, option)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    aweme_id = '7000000000000000000' # str | 视频aweme_id/Aweme_id of video
option = '1' # str | 选项/Option

    try:
        # 抖音视频点赞观众画像/Douyin Video Like Viewer Portrait
        api_response = api_instance.fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get(aweme_id, option)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **aweme_id** | **str**| 视频aweme_id/Aweme_id of video | 
 **option** | **str**| 选项/Option | 
...
# **fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get_0**
> ResponseModel fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get_0(aweme_id, option)
...
option = '1' # str | 选项/Option
    ...
    try:
        # 抖音视频点赞观众画像/Douyin Video Like Viewer Portrait
        api_response = api_instance.fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get_0(aweme_id, option)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_like_portrait_api_v1_douyin_web_fetch_video_like_portrait_get_0: %s\n" % e)
```
...
# **fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get**
> ResponseModel fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的视频搜索结果/Get video search results of specified keywords
        api_response = api_instance.fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get: %s\n" % e)
```
...
# **fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get_0**
> ResponseModel fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get_0(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的视频搜索结果/Get video search results of specified keywords
        api_response = api_instance.fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get_0(keyword, offset=offset, count=count, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_search_result_api_v1_douyin_web_fetch_video_search_result_get_0: %s\n" % e)
```
...
# **fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get**
> ResponseModel fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    keyword = '中华娘' # str | 关键词/Keyword
sort_type = '_0' # str | 排序类型/Sort type (optional) (default to '_0')
publish_time = '_0' # str | 发布时间/Publish time (optional) (default to '_0')
filter_duration = '_0' # str | 视频时长/Duration filter (optional) (default to '_0')
page = 1 # int | 页码/Page (optional) (default to 1)
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')

    try:
        # 获取指定关键词的视频搜索结果V2/Get video search results of specified keywords V2
        api_response = api_instance.fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **keyword** | **str**| 关键词/Keyword | 
 **sort_type** | **str**| 排序类型/Sort type | [optional] [default to &#39;_0&#39;]
 **publish_time** | **str**| 发布时间/Publish time | [optional] [default to &#39;_0&#39;]
 **filter_duration** | **str**| 视频时长/Duration filter | [optional] [default to &#39;_0&#39;]
 **page** | **int**| 页码/Page | [optional] [default to 1]
 **search_id** | **str**| 搜索id，翻页时需要提供/Search id, need to provide when paging | [optional] [default to &#39;&#39;]
...
# **fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get_0**
> ResponseModel fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get_0(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
...
search_id = '' # str | 搜索id，翻页时需要提供/Search id, need to provide when paging (optional) (default to '')
    ...
    try:
        # 获取指定关键词的视频搜索结果V2/Get video search results of specified keywords V2
        api_response = api_instance.fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get_0(keyword, sort_type=sort_type, publish_time=publish_time, filter_duration=filter_duration, page=page, search_id=search_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->fetch_video_search_result_v2_api_v1_douyin_web_fetch_video_search_result_v2_get_0: %s\n" % e)
```
...
# **generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post**
> ResponseModel generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post(a_bogus_model=a_bogus_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    a_bogus_model = tikhub_sdk_v2.ABogusModel() # ABogusModel |  (optional)

    try:
        # 使用接口网址生成A-Bogus参数/Generate A-Bogus parameter using API URL
        api_response = api_instance.generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post(a_bogus_model=a_bogus_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **a_bogus_model** | [**ABogusModel**](ABogusModel.md)|  | [optional] 
...
# **generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post_0**
> ResponseModel generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post_0(a_bogus_model=a_bogus_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 使用接口网址生成A-Bogus参数/Generate A-Bogus parameter using API URL
        api_response = api_instance.generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post_0(a_bogus_model=a_bogus_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_a_bogus_api_v1_douyin_web_generate_a_bogus_post_0: %s\n" % e)
```
...
# **generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get**
> ResponseModel generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成真实msToken/Generate real msToken
        api_response = api_instance.generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get: %s\n" % e)
```
...
# **generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get_0**
> ResponseModel generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成真实msToken/Generate real msToken
        api_response = api_instance.generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_real_ms_token_api_v1_douyin_web_generate_real_ms_token_get_0: %s\n" % e)
```
...
# **generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get**
> ResponseModel generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成s_v_web_id/Generate s_v_web_id
        api_response = api_instance.generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get: %s\n" % e)
```
...
# **generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get_0**
> ResponseModel generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成s_v_web_id/Generate s_v_web_id
        api_response = api_instance.generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_sv_web_id_api_v1_douyin_web_generate_sv_web_id_get_0: %s\n" % e)
```
...
# **generate_ttwid_api_v1_douyin_web_generate_ttwid_get**
> ResponseModel generate_ttwid_api_v1_douyin_web_generate_ttwid_get(user_agent=user_agent)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:125.0) Gecko/20100101 Firefox/125.0' # str |  (optional) (default to 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:125.0) Gecko/20100101 Firefox/125.0')

    try:
        # 生成ttwid/Generate ttwid
        api_response = api_instance.generate_ttwid_api_v1_douyin_web_generate_ttwid_get(user_agent=user_agent)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_ttwid_api_v1_douyin_web_generate_ttwid_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user_agent** | **str**|  | [optional] [default to &#39;Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:125.0) Gecko/20100101 Firefox/125.0&#39;]
...
# **generate_ttwid_api_v1_douyin_web_generate_ttwid_get_0**
> ResponseModel generate_ttwid_api_v1_douyin_web_generate_ttwid_get_0(user_agent=user_agent)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成ttwid/Generate ttwid
        api_response = api_instance.generate_ttwid_api_v1_douyin_web_generate_ttwid_get_0(user_agent=user_agent)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_ttwid_api_v1_douyin_web_generate_ttwid_get_0: %s\n" % e)
```
...
# **generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get**
> ResponseModel generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成verify_fp/Generate verify_fp
        api_response = api_instance.generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get: %s\n" % e)
```
...
# **generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get_0**
> ResponseModel generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成verify_fp/Generate verify_fp
        api_response = api_instance.generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_verify_fp_api_v1_douyin_web_generate_verify_fp_get_0: %s\n" % e)
```
...
# **generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post**
> ResponseModel generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post(x_bogus_model=x_bogus_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    x_bogus_model = tikhub_sdk_v2.XBogusModel() # XBogusModel |  (optional)

    try:
        # 使用接口网址生成X-Bogus参数/Generate X-Bogus parameter using API URL
        api_response = api_instance.generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post(x_bogus_model=x_bogus_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **x_bogus_model** | [**XBogusModel**](XBogusModel.md)|  | [optional] 
...
# **generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post_0**
> ResponseModel generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post_0(x_bogus_model=x_bogus_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 使用接口网址生成X-Bogus参数/Generate X-Bogus parameter using API URL
        api_response = api_instance.generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post_0(x_bogus_model=x_bogus_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->generate_x_bogus_api_v1_douyin_web_generate_x_bogus_post_0: %s\n" % e)
```
...
# **get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post**
> ResponseModel get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    request_body = ["0.53 02/26 I@v.sE Fus:/ 你别太帅了郑润泽# 现场版live # 音乐节 # 郑润泽  https://v.douyin.com/iRNBho6u/ 复制此链接，打开Dou音搜索，直接观看视频!","https://v.douyin.com/iRNBho6u/","https://www.iesdouyin.com/share/video/7298145681699622182/?region=CN&mid=7298145762238565171&u_code=l1j9bkbd&did=MS4wLjABAAAAtqpCx0hpOERbdSzQdjRZw-wFPxaqdbAzsKDmbJMUI3KWlMGQHC-n6dXAqa-dM2EP&iid=MS4wLjABAAAANwkJuWIRFOzg5uCpDRpMj4OX-QryoDgn-yYlXQnRwQQ&with_sec_did=1&titleType=title&share_sign=05kGlqGmR4_IwCX.ZGk6xuL0osNA..5ur7b0jbOx6cc-&share_version=170400&ts=1699262937&from_aid=6383&from_ssr=1&from=web_code_link","https://www.douyin.com/video/7298145681699622182?previous_page=web_code_link","https://www.douyin.com/video/7298145681699622182"] # list[str] |  (optional)

    try:
        # 提取列表作品id/Extract list video id
        api_response = api_instance.get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post: %s\n" % e)
```
...
# **get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post_0**
> ResponseModel get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取列表作品id/Extract list video id
        api_response = api_instance.get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_all_aweme_id_api_v1_douyin_web_get_all_aweme_id_post_0: %s\n" % e)
```
...
# **get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post**
> ResponseModel get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    request_body = ["https://www.douyin.com/user/MS4wLjABAAAANXSltcLCzDGmdNFI2Q_QixVTr67NiYzjKOIP5s03CAE?vid=7285950278132616463","https://www.douyin.com/user/MS4wLjABAAAAVsneOf144eGDFf8Xp9QNb1VW6ovXnNT5SqJBhJfe8KQBKWKDTWK5Hh-_i9mJzb8C","长按复制此条消息，打开抖音搜索，查看TA的更多作品。 https://v.douyin.com/idFqvUms/","https://v.douyin.com/idFqvUms/"] # list[str] |  (optional)

    try:
        # 提取列表用户id/Extract list user id
        api_response = api_instance.get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post: %s\n" % e)
```
...
# **get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post_0**
> ResponseModel get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取列表用户id/Extract list user id
        api_response = api_instance.get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_all_sec_user_id_api_v1_douyin_web_get_all_sec_user_id_post_0: %s\n" % e)
```
...
# **get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post**
> ResponseModel get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    request_body = ["https://live.douyin.com/775841227732","https://live.douyin.com/775841227732?room_id=7318296342189919011&enter_from_merge=web_share_link&enter_method=web_share_link&previous_page=app_code_link","https://webcast.amemv.com/douyin/webcast/reflow/7318296342189919011?u_code=l1j9bkbd&did=MS4wLjABAAAAEs86TBQPNwAo-RGrcxWyCdwKhI66AK3Pqf3ieo6HaxI&iid=MS4wLjABAAAA0ptpM-zzoliLEeyvWOCUt-_dQza4uSjlIvbtIazXnCY&with_sec_did=1&use_link_command=1&ecom_share_track_params=&extra_params={\"from_request_id\":\"20231230162057EC005772A8EAA0199906\",\"im_channel_invite_id\":\"0\"}&user_id=3644207898042206&liveId=7318296342189919011&from=share&style=share&enter_method=click_share&roomId=7318296342189919011&activity_info={}","6i- Q@x.Sl 03/23 【醒子8ke的直播间】  点击打开👉https://v.douyin.com/i8tBR7hX/  或长按复制此条消息，打开抖音，看TA直播","https://v.douyin.com/i8tBR7hX/"] # list[str] |  (optional)

    try:
        # 提取列表直播间号/Extract list webcast id
        api_response = api_instance.get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post: %s\n" % e)
```
...
# **get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post_0**
> ResponseModel get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取列表直播间号/Extract list webcast id
        api_response = api_instance.get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_all_webcast_id_api_v1_douyin_web_get_all_webcast_id_post_0: %s\n" % e)
```
...
# **get_aweme_id_api_v1_douyin_web_get_aweme_id_get**
> ResponseModel get_aweme_id_api_v1_douyin_web_get_aweme_id_get(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    url = 'https://www.douyin.com/video/7298145681699622182' # str | 

    try:
        # 提取单个作品id/Extract single video id
        api_response = api_instance.get_aweme_id_api_v1_douyin_web_get_aweme_id_get(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_aweme_id_api_v1_douyin_web_get_aweme_id_get: %s\n" % e)
```
...
# **get_aweme_id_api_v1_douyin_web_get_aweme_id_get_0**
> ResponseModel get_aweme_id_api_v1_douyin_web_get_aweme_id_get_0(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取单个作品id/Extract single video id
        api_response = api_instance.get_aweme_id_api_v1_douyin_web_get_aweme_id_get_0(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_aweme_id_api_v1_douyin_web_get_aweme_id_get_0: %s\n" % e)
```
...
# **get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get**
> ResponseModel get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    url = 'https://www.douyin.com/user/MS4wLjABAAAANXSltcLCzDGmdNFI2Q_QixVTr67NiYzjKOIP5s03CAE' # str | 

    try:
        # 提取单个用户id/Extract single user id
        api_response = api_instance.get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get: %s\n" % e)
```
...
# **get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get_0**
> ResponseModel get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get_0(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取单个用户id/Extract single user id
        api_response = api_instance.get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get_0(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_sec_user_id_api_v1_douyin_web_get_sec_user_id_get_0: %s\n" % e)
```
...
# **get_webcast_id_api_v1_douyin_web_get_webcast_id_get**
> ResponseModel get_webcast_id_api_v1_douyin_web_get_webcast_id_get(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    url = 'https://live.douyin.com/775841227732' # str | 

    try:
        # 提取直播间号/Extract webcast id
        api_response = api_instance.get_webcast_id_api_v1_douyin_web_get_webcast_id_get(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_webcast_id_api_v1_douyin_web_get_webcast_id_get: %s\n" % e)
```
...
# **get_webcast_id_api_v1_douyin_web_get_webcast_id_get_0**
> ResponseModel get_webcast_id_api_v1_douyin_web_get_webcast_id_get_0(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取直播间号/Extract webcast id
        api_response = api_instance.get_webcast_id_api_v1_douyin_web_get_webcast_id_get_0(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->get_webcast_id_api_v1_douyin_web_get_webcast_id_get_0: %s\n" % e)
```
...
# **handler_user_profile_api_v1_douyin_web_handler_user_profile_get**
> ResponseModel handler_user_profile_api_v1_douyin_web_handler_user_profile_get(sec_user_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据sec_user_id获取指定用户的信息/Get information of specified user by sec_user_id
        api_response = api_instance.handler_user_profile_api_v1_douyin_web_handler_user_profile_get(sec_user_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->handler_user_profile_api_v1_douyin_web_handler_user_profile_get: %s\n" % e)
```
...
# **handler_user_profile_api_v1_douyin_web_handler_user_profile_get_0**
> ResponseModel handler_user_profile_api_v1_douyin_web_handler_user_profile_get_0(sec_user_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据sec_user_id获取指定用户的信息/Get information of specified user by sec_user_id
        api_response = api_instance.handler_user_profile_api_v1_douyin_web_handler_user_profile_get_0(sec_user_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->handler_user_profile_api_v1_douyin_web_handler_user_profile_get_0: %s\n" % e)
```
...
# **handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get**
> ResponseModel handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get(unique_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    unique_id = 'TheChief' # str | 用户unique_id/User unique_id

    try:
        # 根据抖音号获取指定用户的信息/Get information of specified user by unique_id
        api_response = api_instance.handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get(unique_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get: %s\n" % e)
```
...
# **handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get_0**
> ResponseModel handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get_0(unique_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据抖音号获取指定用户的信息/Get information of specified user by unique_id
        api_response = api_instance.handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get_0(unique_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->handler_user_profile_v2_api_v1_douyin_web_handler_user_profile_v2_get_0: %s\n" % e)
```
...
# **handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get**
> ResponseModel handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get(uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    uid = '1673937488185292' # str | 用户uid(short_id)/User uid(short_id)

    try:
        # 根据抖音uid获取指定用户的信息/Get information of specified user by uid
        api_response = api_instance.handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get(uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get: %s\n" % e)
```
...
# **handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get_0**
> ResponseModel handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get_0(uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据抖音uid获取指定用户的信息/Get information of specified user by uid
        api_response = api_instance.handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get_0(uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->handler_user_profile_v3_api_v1_douyin_web_handler_user_profile_v3_get_0: %s\n" % e)
```
...
# **webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get**
> ResponseModel webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get(webcast_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.DouyinWebAPIApi(api_client)
    webcast_id = '775841227732' # str | 直播间号/Webcast id

    try:
        # 直播间号转房间号/Webcast id to room id
        api_response = api_instance.webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get(webcast_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get: %s\n" % e)
```
...
# **webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get_0**
> ResponseModel webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get_0(webcast_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 直播间号转房间号/Webcast id to room id
        api_response = api_instance.webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get_0(webcast_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinWebAPIApi->webcast_id2_room_id_api_v1_douyin_web_webcast_id2_room_id_get_0: %s\n" % e)
```
