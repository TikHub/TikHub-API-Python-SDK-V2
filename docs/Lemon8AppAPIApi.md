...
[**fetch_user_follower_list_api_v1_lemon8_app_fetch_user_follower_list_get_0**](Lemon8AppAPIApi.md#fetch_user_follower_list_api_v1_lemon8_app_fetch_user_follower_list_get_0) | **GET** /api/v1/lemon8/app/fetch_user_follower_list | 获取指定用户的粉丝列表/Get fans list of specified user
...
> ResponseModel fetch_post_comment_list_api_v1_lemon8_app_fetch_post_comment_list_get(group_id, item_id, media_id, offset=offset)
...
offset = '0' # str | 翻页参数/Pagination parameter (optional) (default to '0')
    ...
    try:
        # 获取指定作品的评论列表/Get comments list of specified post
        api_response = api_instance.fetch_post_comment_list_api_v1_lemon8_app_fetch_post_comment_list_get_0(group_id, item_id, media_id, offset=offset)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling Lemon8AppAPIApi->fetch_post_comment_list_api_v1_lemon8_app_fetch_post_comment_list_get_0: %s\n" % e)
```
...
# **fetch_post_detail_api_v1_lemon8_app_fetch_post_detail_get_0**
...
> ResponseModel fetch_topic_post_list_api_v1_lemon8_app_fetch_topic_post_list_get(category, category_parameter, hashtag_name, max_behot_time=max_behot_time, sort_type=sort_type)
...
# **fetch_topic_post_list_api_v1_lemon8_app_fetch_topic_post_list_get_0**
> ResponseModel fetch_topic_post_list_api_v1_lemon8_app_fetch_topic_post_list_get_0(category, category_parameter, hashtag_name, max_behot_time=max_behot_time, sort_type=sort_type)
...
> ResponseModel fetch_user_following_list_api_v1_lemon8_app_fetch_user_following_list_get(user_id, cursor=cursor)
...
cursor = '' # str | 翻页参数/Pagination parameter (optional) (default to '')
    ...
    try:
        # 获取指定用户的关注列表/Get following list of specified user
        api_response = api_instance.fetch_user_following_list_api_v1_lemon8_app_fetch_user_following_list_get(user_id, cursor=cursor)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_following_list_api_v1_lemon8_app_fetch_user_following_list_get_0**
> ResponseModel fetch_user_following_list_api_v1_lemon8_app_fetch_user_following_list_get_0(user_id, cursor=cursor)
...
> ResponseModel get_item_id_api_v1_lemon8_app_get_item_id_get(share_text)
...
> ResponseModel get_item_ids_api_v1_lemon8_app_get_item_ids_post(request_body=request_body)
...
> ResponseModel get_user_id_api_v1_lemon8_app_get_user_id_get(share_text)
...
> ResponseModel get_user_ids_api_v1_lemon8_app_get_user_ids_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.Lemon8AppAPIApi(api_client)
    request_body = ["https://www.lemon8-app.com/lemon8cars?region=us","https://v.lemon8-app.com/al/OgZrsUppx"] # list[str] |  (optional)
...
# **get_user_ids_api_v1_lemon8_app_get_user_ids_post_0**
> ResponseModel get_user_ids_api_v1_lemon8_app_get_user_ids_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 通过分享链接批量获取用户ID/Get user IDs in batch through sharing links
        api_response = api_instance.get_user_ids_api_v1_lemon8_app_get_user_ids_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling Lemon8AppAPIApi->get_user_ids_api_v1_lemon8_app_get_user_ids_post_0: %s\n" % e)
```
...
> ResponseModel handler_user_profile_api_v1_lemon8_app_fetch_user_profile_get(user_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.Lemon8AppAPIApi(api_client)
    user_id = '7217844966059656197' # str | 用户ID/User ID

    try:
        # 获取指定用户的信息/Get information of specified user
        api_response = api_instance.handler_user_profile_api_v1_lemon8_app_fetch_user_profile_get(user_id)
        pprint(api_response)
    except ApiException as e:
...
# **handler_user_profile_api_v1_lemon8_app_fetch_user_profile_get_0**
> ResponseModel handler_user_profile_api_v1_lemon8_app_fetch_user_profile_get_0(user_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取指定用户的信息/Get information of specified user
        api_response = api_instance.handler_user_profile_api_v1_lemon8_app_fetch_user_profile_get_0(user_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling Lemon8AppAPIApi->handler_user_profile_api_v1_lemon8_app_fetch_user_profile_get_0: %s\n" % e)
```
