# tikhub_sdk_v2.DouyinXingtuAPIApi
...
[**kol_conversion_ability_analysis_v1_api_v1_douyin_xingtu_kol_conversion_ability_analysis_v1_get_0**](DouyinXingtuAPIApi.md#kol_conversion_ability_analysis_v1_api_v1_douyin_xingtu_kol_conversion_ability_analysis_v1_get_0) | **GET** /api/v1/douyin/xingtu/kol_conversion_ability_analysis_v1 | 获取kol转化能力分析V1/Get kol Conversion Ability Analysis V1
...
[**kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get_0**](DouyinXingtuAPIApi.md#kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get_0) | **GET** /api/v1/douyin/xingtu/kol_video_performance_v1 | 获取kol视频表现V1/Get kol Video Performance V1
...
# **author_hot_comment_tokens_v1_api_v1_douyin_xingtu_author_hot_comment_tokens_v1_get_0**
> ResponseModel author_hot_comment_tokens_v1_api_v1_douyin_xingtu_author_hot_comment_tokens_v1_get_0(kol_id)
...
# **get_xingtu_kolid_by_uid_api_v1_douyin_xingtu_get_xingtu_kolid_by_uid_get**
> ResponseModel get_xingtu_kolid_by_uid_api_v1_douyin_xingtu_get_xingtu_kolid_by_uid_get(uid)
...
# **get_xingtu_kolid_by_unique_id_api_v1_douyin_xingtu_get_xingtu_kolid_by_unique_id_get_0**
> ResponseModel get_xingtu_kolid_by_unique_id_api_v1_douyin_xingtu_get_xingtu_kolid_by_unique_id_get_0(unique_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据抖音号获取游客星图kolid/Get XingTu kolid by Douyin unique_id
        api_response = api_instance.get_xingtu_kolid_by_unique_id_api_v1_douyin_xingtu_get_xingtu_kolid_by_unique_id_get_0(unique_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->get_xingtu_kolid_by_unique_id_api_v1_douyin_xingtu_get_xingtu_kolid_by_unique_id_get_0: %s\n" % e)
```
...
# **kol_audience_portrait_v1_api_v1_douyin_xingtu_kol_audience_portrait_v1_get**
> ResponseModel kol_audience_portrait_v1_api_v1_douyin_xingtu_kol_audience_portrait_v1_get(kol_id)
...
# **kol_audience_portrait_v1_api_v1_douyin_xingtu_kol_audience_portrait_v1_get_0**
> ResponseModel kol_audience_portrait_v1_api_v1_douyin_xingtu_kol_audience_portrait_v1_get_0(kol_id)
...
# **kol_conversion_ability_analysis_v1_api_v1_douyin_xingtu_kol_conversion_ability_analysis_v1_get**
> ResponseModel kol_conversion_ability_analysis_v1_api_v1_douyin_xingtu_kol_conversion_ability_analysis_v1_get(kol_id, range)
...
# **kol_conversion_ability_analysis_v1_api_v1_douyin_xingtu_kol_conversion_ability_analysis_v1_get_0**
> ResponseModel kol_conversion_ability_analysis_v1_api_v1_douyin_xingtu_kol_conversion_ability_analysis_v1_get_0(kol_id, range)
...
page = 1 # int | 页码/Page
    ...
    try:
        # 获取kol转化视频展示V1/Get kol Convert Video Display V1
        api_response = api_instance.kol_convert_video_display_v1_api_v1_douyin_xingtu_kol_convert_video_display_v1_get(kol_id, detail_type, page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_convert_video_display_v1_api_v1_douyin_xingtu_kol_convert_video_display_v1_get: %s\n" % e)
```
...
# **kol_convert_video_display_v1_api_v1_douyin_xingtu_kol_convert_video_display_v1_get_0**
> ResponseModel kol_convert_video_display_v1_api_v1_douyin_xingtu_kol_convert_video_display_v1_get_0(kol_id, detail_type, page)
...
# **kol_cp_info_v1_api_v1_douyin_xingtu_kol_cp_info_v1_get**
> ResponseModel kol_cp_info_v1_api_v1_douyin_xingtu_kol_cp_info_v1_get(kol_id)
...
# **kol_daily_fans_v1_api_v1_douyin_xingtu_kol_daily_fans_v1_get_0**
> ResponseModel kol_daily_fans_v1_api_v1_douyin_xingtu_kol_daily_fans_v1_get_0(kol_id, start_date, end_date)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    kol_id = '7048929565493690398' # str | 用户的kolId/User kolId
type = '_1' # str | 类型/Type
range = '_2' # str | 范围/Range
flow_type = 1 # int | 流量类型/Flow Type

    try:
        # 获取kol数据概览V1/Get kol Data Overview V1
        api_response = api_instance.kol_data_overview_v1_api_v1_douyin_xingtu_kol_data_overview_v1_get(kol_id, type, range, flow_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_data_overview_v1_api_v1_douyin_xingtu_kol_data_overview_v1_get: %s\n" % e)
```
...
# **kol_data_overview_v1_api_v1_douyin_xingtu_kol_data_overview_v1_get_0**
> ResponseModel kol_data_overview_v1_api_v1_douyin_xingtu_kol_data_overview_v1_get_0(kol_id, type, range, flow_type)
...
flow_type = 1 # int | 流量类型/Flow Type
    ...
    try:
        # 获取kol数据概览V1/Get kol Data Overview V1
        api_response = api_instance.kol_data_overview_v1_api_v1_douyin_xingtu_kol_data_overview_v1_get_0(kol_id, type, range, flow_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_data_overview_v1_api_v1_douyin_xingtu_kol_data_overview_v1_get_0: %s\n" % e)
```
...
# **kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get**
> ResponseModel kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol粉丝画像V1/Get kol Fans Portrait V1
        api_response = api_instance.kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get: %s\n" % e)
```
...
# **kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get_0**
> ResponseModel kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get_0(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol粉丝画像V1/Get kol Fans Portrait V1
        api_response = api_instance.kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get_0(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_fans_portrait_v1_api_v1_douyin_xingtu_kol_fans_portrait_v1_get_0: %s\n" % e)
```
...
# **kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get**
> ResponseModel kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol连接用户V1/Get kol Link Struct V1
        api_response = api_instance.kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get: %s\n" % e)
```
...
# **kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get_0**
> ResponseModel kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get_0(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol连接用户V1/Get kol Link Struct V1
        api_response = api_instance.kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get_0(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_link_struct_v1_api_v1_douyin_xingtu_kol_link_struct_v1_get_0: %s\n" % e)
```
...
# **kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get**
> ResponseModel kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol内容表现V1/Get kol Rec Videos V1
        api_response = api_instance.kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get: %s\n" % e)
```
...
# **kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get_0**
> ResponseModel kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get_0(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol内容表现V1/Get kol Rec Videos V1
        api_response = api_instance.kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get_0(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_rec_videos_v1_api_v1_douyin_xingtu_kol_rec_videos_v1_get_0: %s\n" % e)
```
...
# **kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get**
> ResponseModel kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get(kol_id, platform_channel)
...
platform_channel = '_1' # str | 平台渠道/Platform Channel
    ...
    try:
        # 获取kol服务报价V1/Get kol Service Price V1
        api_response = api_instance.kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get(kol_id, platform_channel)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get: %s\n" % e)
```
...
# **kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get_0**
> ResponseModel kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get_0(kol_id, platform_channel)
...
platform_channel = '_1' # str | 平台渠道/Platform Channel
    ...
    try:
        # 获取kol服务报价V1/Get kol Service Price V1
        api_response = api_instance.kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get_0(kol_id, platform_channel)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_service_price_v1_api_v1_douyin_xingtu_kol_service_price_v1_get_0: %s\n" % e)
```
...
# **kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get**
> ResponseModel kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol连接用户来源V1/Get kol Touch Distribution V1
        api_response = api_instance.kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get: %s\n" % e)
```
...
# **kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get_0**
> ResponseModel kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get_0(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol连接用户来源V1/Get kol Touch Distribution V1
        api_response = api_instance.kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get_0(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_touch_distribution_v1_api_v1_douyin_xingtu_kol_touch_distribution_v1_get_0: %s\n" % e)
```
...
# **kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get**
> ResponseModel kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get(kol_id, only_assign)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    api_instance = tikhub_sdk_v2.DouyinXingtuAPIApi(api_client)
    kol_id = '7048929565493690398' # str | 用户的kolId/User kolId
only_assign = false # bool | 是否只显示分配作品/Whether to display only assigned works

    try:
        # 获取kol视频表现V1/Get kol Video Performance V1
        api_response = api_instance.kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get(kol_id, only_assign)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get: %s\n" % e)
```
...
# **kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get_0**
> ResponseModel kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get_0(kol_id, only_assign)
...
only_assign = false # bool | 是否只显示分配作品/Whether to display only assigned works
    ...
    try:
        # 获取kol视频表现V1/Get kol Video Performance V1
        api_response = api_instance.kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get_0(kol_id, only_assign)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_video_performance_v1_api_v1_douyin_xingtu_kol_video_performance_v1_get_0: %s\n" % e)
```
...
# **kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get**
> ResponseModel kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol星图指数V1/Get kol Xingtu Index V1
        api_response = api_instance.kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get: %s\n" % e)
```
...
# **kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get_0**
> ResponseModel kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get_0(kol_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取kol星图指数V1/Get kol Xingtu Index V1
        api_response = api_instance.kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get_0(kol_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->kol_xingtu_index_v1_api_v1_douyin_xingtu_kol_xingtu_index_v1_get_0: %s\n" % e)
```
...
# **search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get**
> ResponseModel search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get(keyword, platform_source, page)
...
platform_source = '_1' # str | 平台来源/Platform Source
page = 1 # int | 页码/Page

    try:
        # 关键词搜索kol V1/Search Kol V1
        api_response = api_instance.search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get(keyword, platform_source, page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get: %s\n" % e)
```
...
# **search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get_0**
> ResponseModel search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get_0(keyword, platform_source, page)
...
page = 1 # int | 页码/Page
    ...
    try:
        # 关键词搜索kol V1/Search Kol V1
        api_response = api_instance.search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get_0(keyword, platform_source, page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DouyinXingtuAPIApi->search_kol_v1_api_v1_douyin_xingtu_search_kol_v1_get_0: %s\n" % e)
```
