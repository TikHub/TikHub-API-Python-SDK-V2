...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling XiaohongshuWebAPIApi->get_user_info_v3_api_v1_xiaohongshu_web_get_user_info_v3_get_0: %s\n" % e)
```
...
last_cursor = 'last_cursor_example' # str | 上一页的游标/Last cursor (optional)
    ...
    try:
        ...
        print("Exception when calling XiaohongshuWebAPIApi->get_user_notes_api_v1_xiaohongshu_web_get_user_notes_get: %s\n" % e)
```
...
last_cursor = 'last_cursor_example' # str | 上一页的游标/Last cursor (optional)
    ...
    try:
        ...
        print("Exception when calling XiaohongshuWebAPIApi->get_user_notes_api_v1_xiaohongshu_web_get_user_notes_get_0: %s\n" % e)
```
...
# **get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get**
> ResponseModel get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get(user_id, last_cursor=last_cursor)
...
last_cursor = 'last_cursor_example' # str | 上一页的游标/Last cursor (optional)
    ...
    try:
        # 获取用户的笔记 V2/Get user notes V2
        api_response = api_instance.get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get(user_id, last_cursor=last_cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get: %s\n" % e)
```
...
# **get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get_0**
> ResponseModel get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get_0(user_id, last_cursor=last_cursor)
...
last_cursor = 'last_cursor_example' # str | 上一页的游标/Last cursor (optional)
    ...
    try:
        # 获取用户的笔记 V2/Get user notes V2
        api_response = api_instance.get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get_0(user_id, last_cursor=last_cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->get_user_notes_api_v1_xiaohongshu_web_get_user_notes_v2_get_0: %s\n" % e)
```
...
# **get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get**
> ResponseModel get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取游客Cookie/Get visitor cookie
        api_response = api_instance.get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get: %s\n" % e)
```
...
# **get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get_0**
> ResponseModel get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取游客Cookie/Get visitor cookie
        api_response = api_instance.get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->get_visitor_cookie_api_v1_xiaohongshu_web_get_visitor_cookie_get_0: %s\n" % e)
```
...
# **search_notes_api_v1_xiaohongshu_web_search_notes_get**
> ResponseModel search_notes_api_v1_xiaohongshu_web_search_notes_get(keyword, page=page, sort=sort, note_type=note_type)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.XiaohongshuWebAPIApi(api_client)
    keyword = '美食' # str | 搜索关键词/Keyword
page = 1 # int | 页码/Page (optional) (default to 1)
sort = 'general' # str | 排序方式/Sort (optional) (default to 'general')
note_type = '_0' # str | 笔记类型/Note type (optional) (default to '_0')

    try:
        # 搜索笔记/Search notes
        api_response = api_instance.search_notes_api_v1_xiaohongshu_web_search_notes_get(keyword, page=page, sort=sort, note_type=note_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->search_notes_api_v1_xiaohongshu_web_search_notes_get: %s\n" % e)
```
 ...
 **sort** | **str**| 排序方式/Sort | [optional] [default to &#39;general&#39;]
 **note_type** | **str**| 笔记类型/Note type | [optional] [default to &#39;_0&#39;]
...
# **search_notes_api_v1_xiaohongshu_web_search_notes_get_0**
> ResponseModel search_notes_api_v1_xiaohongshu_web_search_notes_get_0(keyword, page=page, sort=sort, note_type=note_type)
...
note_type = '_0' # str | 笔记类型/Note type (optional) (default to '_0')
    ...
    try:
        # 搜索笔记/Search notes
        api_response = api_instance.search_notes_api_v1_xiaohongshu_web_search_notes_get_0(keyword, page=page, sort=sort, note_type=note_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->search_notes_api_v1_xiaohongshu_web_search_notes_get_0: %s\n" % e)
```
...
# **search_users_api_v1_xiaohongshu_web_search_users_get**
> ResponseModel search_users_api_v1_xiaohongshu_web_search_users_get(keyword, page=page)
...
page = 1 # int | 页码/Page (optional) (default to 1)
    ...
    try:
        # 搜索用户/Search users
        api_response = api_instance.search_users_api_v1_xiaohongshu_web_search_users_get(keyword, page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->search_users_api_v1_xiaohongshu_web_search_users_get: %s\n" % e)
```
...
# **search_users_api_v1_xiaohongshu_web_search_users_get_0**
> ResponseModel search_users_api_v1_xiaohongshu_web_search_users_get_0(keyword, page=page)
...
page = 1 # int | 页码/Page (optional) (default to 1)
    ...
    try:
        # 搜索用户/Search users
        api_response = api_instance.search_users_api_v1_xiaohongshu_web_search_users_get_0(keyword, page=page)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->search_users_api_v1_xiaohongshu_web_search_users_get_0: %s\n" % e)
```
...
# **sign_api_v1_xiaohongshu_web_sign_post**
> ResponseModel sign_api_v1_xiaohongshu_web_sign_post(xhs_web_sign_request_model=xhs_web_sign_request_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.XiaohongshuWebAPIApi(api_client)
    xhs_web_sign_request_model = tikhub_sdk_v2.XhsWebSignRequestModel() # XhsWebSignRequestModel |  (optional)

    try:
        # 小红书Web签名/Xiaohongshu Web sign
        api_response = api_instance.sign_api_v1_xiaohongshu_web_sign_post(xhs_web_sign_request_model=xhs_web_sign_request_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->sign_api_v1_xiaohongshu_web_sign_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **xhs_web_sign_request_model** | [**XhsWebSignRequestModel**](XhsWebSignRequestModel.md)|  | [optional] 
...
# **sign_api_v1_xiaohongshu_web_sign_post_0**
> ResponseModel sign_api_v1_xiaohongshu_web_sign_post_0(xhs_web_sign_request_model=xhs_web_sign_request_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 小红书Web签名/Xiaohongshu Web sign
        api_response = api_instance.sign_api_v1_xiaohongshu_web_sign_post_0(xhs_web_sign_request_model=xhs_web_sign_request_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling XiaohongshuWebAPIApi->sign_api_v1_xiaohongshu_web_sign_post_0: %s\n" % e)
```
