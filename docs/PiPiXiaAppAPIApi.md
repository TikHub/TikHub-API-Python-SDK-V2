# tikhub_sdk_v2.PiPiXiaAppAPIApi
...
[**fetch_post_detail_api_v1_pipixia_app_fetch_post_detail_get_0**](PiPiXiaAppAPIApi.md#fetch_post_detail_api_v1_pipixia_app_fetch_post_detail_get_0) | **GET** /api/v1/pipixia/app/fetch_post_detail | 获取单个作品数据/Get single video data
...
> ResponseModel fetch_increase_post_view_count_api_v1_pipixia_app_fetch_increase_post_view_count_get(cell_id, cell_type=cell_type)
...
# **fetch_post_comment_list_api_v1_pipixia_app_fetch_post_comment_list_get_0**
> ResponseModel fetch_post_comment_list_api_v1_pipixia_app_fetch_post_comment_list_get_0(cell_id, cell_type=cell_type, offset=offset)
...
> ResponseModel fetch_user_follower_list_api_v1_pipixia_app_fetch_user_follower_list_get(user_id, cursor=cursor)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取用户信息/Get user information
        api_response = api_instance.fetch_user_info_api_v1_pipixia_app_fetch_user_info_get(user_id)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_info_api_v1_pipixia_app_fetch_user_info_get_0**
> ResponseModel fetch_user_info_api_v1_pipixia_app_fetch_user_info_get_0(user_id)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取用户信息/Get user information
        api_response = api_instance.fetch_user_info_api_v1_pipixia_app_fetch_user_info_get_0(user_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PiPiXiaAppAPIApi->fetch_user_info_api_v1_pipixia_app_fetch_user_info_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_post_list_api_v1_pipixia_app_fetch_user_post_list_get(user_id, cursor=cursor, feed_count=feed_count)
...
feed_count = '0' # str | 翻页数量/Page count (optional) (default to '0')
    ...
    try:
        # 获取用户作品列表/Get user post list
        api_response = api_instance.fetch_user_post_list_api_v1_pipixia_app_fetch_user_post_list_get(user_id, cursor=cursor, feed_count=feed_count)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_user_post_list_api_v1_pipixia_app_fetch_user_post_list_get_0**
> ResponseModel fetch_user_post_list_api_v1_pipixia_app_fetch_user_post_list_get_0(user_id, cursor=cursor, feed_count=feed_count)
...
feed_count = '0' # str | 翻页数量/Page count (optional) (default to '0')
    ...
    try:
        # 获取用户作品列表/Get user post list
        api_response = api_instance.fetch_user_post_list_api_v1_pipixia_app_fetch_user_post_list_get_0(user_id, cursor=cursor, feed_count=feed_count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling PiPiXiaAppAPIApi->fetch_user_post_list_api_v1_pipixia_app_fetch_user_post_list_get_0: %s\n" % e)
```
