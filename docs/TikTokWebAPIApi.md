...
[**fetch_search_keyword_suggest_api_v1_tiktok_web_fetch_search_keyword_suggest_get_0**](TikTokWebAPIApi.md#fetch_search_keyword_suggest_api_v1_tiktok_web_fetch_search_keyword_suggest_get_0) | **GET** /api/v1/tiktok/web/fetch_search_keyword_suggest | 搜索关键字推荐/Search keyword suggest
...
[**fetch_user_like_api_v1_tiktok_web_fetch_user_like_get_0**](TikTokWebAPIApi.md#fetch_user_like_api_v1_tiktok_web_fetch_user_like_get_0) | **GET** /api/v1/tiktok/web/fetch_user_like | 获取用户的点赞列表/Get user likes
...
[**get_aweme_id_api_v1_tiktok_web_get_aweme_id_get_0**](TikTokWebAPIApi.md#get_aweme_id_api_v1_tiktok_web_get_aweme_id_get_0) | **GET** /api/v1/tiktok/web/get_aweme_id | 提取单个作品id/Extract single video id
...
# **douyin_live_room_api_v1_tiktok_web_tiktok_live_room_get_0**
> ResponseModel douyin_live_room_api_v1_tiktok_web_tiktok_live_room_get_0(live_room_url, danmaku_type)
...
# **fetch_check_live_alive_api_v1_tiktok_web_fetch_check_live_alive_get_0**
> ResponseModel fetch_check_live_alive_api_v1_tiktok_web_fetch_check_live_alive_get_0(room_id)
...
count = 16 # int | 每页数量/Number per page (optional) (default to 16)
    ...
    try:
        # 获取探索作品数据/Get explore video data
        api_response = api_instance.fetch_explore_post_api_v1_tiktok_web_fetch_explore_post_get(category_type=category_type, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_explore_post_api_v1_tiktok_web_fetch_explore_post_get: %s\n" % e)
```
...
# **fetch_general_search_api_v1_tiktok_web_fetch_general_search_get**
> ResponseModel fetch_general_search_api_v1_tiktok_web_fetch_general_search_get(keyword, offset=offset, search_id=search_id, cookie=cookie)
...
# **fetch_general_search_api_v1_tiktok_web_fetch_general_search_get_0**
> ResponseModel fetch_general_search_api_v1_tiktok_web_fetch_general_search_get_0(keyword, offset=offset, search_id=search_id, cookie=cookie)
...
# **fetch_live_recommend_api_v1_tiktok_web_fetch_live_recommend_get_0**
> ResponseModel fetch_live_recommend_api_v1_tiktok_web_fetch_live_recommend_get_0(related_live_tag)
...
# **fetch_post_comment_api_v1_tiktok_web_fetch_post_comment_get_0**
> ResponseModel fetch_post_comment_api_v1_tiktok_web_fetch_post_comment_get_0(aweme_id, cursor=cursor, count=count, current_region=current_region)
...
# **fetch_post_comment_reply_api_v1_tiktok_web_fetch_post_comment_reply_get**
> ResponseModel fetch_post_comment_reply_api_v1_tiktok_web_fetch_post_comment_reply_get(item_id, comment_id, cursor=cursor, count=count, current_region=current_region)
...
current_region = '' # str | 当前地区/Current region (optional) (default to '')
    ...
    try:
        # 获取作品的评论回复列表/Get video comment replies
        api_response = api_instance.fetch_post_comment_reply_api_v1_tiktok_web_fetch_post_comment_reply_get(item_id, comment_id, cursor=cursor, count=count, current_region=current_region)
        pprint(api_response)
    except ApiException as e:
...
# **fetch_post_detail_api_v1_tiktok_web_fetch_post_detail_get**
> ResponseModel fetch_post_detail_api_v1_tiktok_web_fetch_post_detail_get(item_id)
...
# **fetch_search_live_api_v1_tiktok_web_fetch_search_live_get**
> ResponseModel fetch_search_live_api_v1_tiktok_web_fetch_search_live_get(keyword, count=count, offset=offset, search_id=search_id, cookie=cookie)
...
# **fetch_search_live_api_v1_tiktok_web_fetch_search_live_get_0**
> ResponseModel fetch_search_live_api_v1_tiktok_web_fetch_search_live_get_0(keyword, count=count, offset=offset, search_id=search_id, cookie=cookie)
...
# **fetch_search_user_api_v1_tiktok_web_fetch_search_user_get**
> ResponseModel fetch_search_user_api_v1_tiktok_web_fetch_search_user_get(keyword, cursor=cursor, search_id=search_id, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户cookie(按需提供)/User cookie(if needed) (optional)
    ...
    try:
        # 搜索用户/Search user
        api_response = api_instance.fetch_search_user_api_v1_tiktok_web_fetch_search_user_get_0(keyword, cursor=cursor, search_id=search_id, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_search_user_api_v1_tiktok_web_fetch_search_user_get_0: %s\n" % e)
```
...
# **fetch_search_video_api_v1_tiktok_web_fetch_search_video_get**
> ResponseModel fetch_search_video_api_v1_tiktok_web_fetch_search_video_get(keyword, count=count, offset=offset, search_id=search_id, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户cookie(按需提供)/User cookie(if needed) (optional)
    ...
    try:
        # 搜索视频/Search video
        api_response = api_instance.fetch_search_video_api_v1_tiktok_web_fetch_search_video_get(keyword, count=count, offset=offset, search_id=search_id, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_search_video_api_v1_tiktok_web_fetch_search_video_get: %s\n" % e)
```
...
# **fetch_search_video_api_v1_tiktok_web_fetch_search_video_get_0**
> ResponseModel fetch_search_video_api_v1_tiktok_web_fetch_search_video_get_0(keyword, count=count, offset=offset, search_id=search_id, cookie=cookie)
...
cookie = 'cookie_example' # str | 用户cookie(按需提供)/User cookie(if needed) (optional)
    ...
    try:
        # 搜索视频/Search video
        api_response = api_instance.fetch_search_video_api_v1_tiktok_web_fetch_search_video_get_0(keyword, count=count, offset=offset, search_id=search_id, cookie=cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_search_video_api_v1_tiktok_web_fetch_search_video_get_0: %s\n" % e)
```
...
# **fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get**
> ResponseModel fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get(tag_name)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    tag_name = 'tiktok' # str | Tag名称/Tag name

    try:
        # Tag详情/Tag Detail
        api_response = api_instance.fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get(tag_name)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get: %s\n" % e)
```
...
# **fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get_0**
> ResponseModel fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get_0(tag_name)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # Tag详情/Tag Detail
        api_response = api_instance.fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get_0(tag_name)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_tag_detail_api_v1_tiktok_web_fetch_tag_detail_get_0: %s\n" % e)
```
...
> ResponseModel fetch_tag_post_api_v1_tiktok_web_fetch_tag_post_get(challenge_id, count=count, cursor=cursor)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    challenge_id = '7551' # str | Tag ID
count = 30 # int | 每页数量/Number per page (optional) (default to 30)
cursor = 0 # int | 翻页游标/Page cursor (optional) (default to 0)

    try:
        # Tag作品/Tag Post
        api_response = api_instance.fetch_tag_post_api_v1_tiktok_web_fetch_tag_post_get(challenge_id, count=count, cursor=cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_tag_post_api_v1_tiktok_web_fetch_tag_post_get: %s\n" % e)
```
 ...
 **count** | **int**| 每页数量/Number per page | [optional] [default to 30]
 **cursor** | **int**| 翻页游标/Page cursor | [optional] [default to 0]
...
# **fetch_tag_post_api_v1_tiktok_web_fetch_tag_post_get_0**
> ResponseModel fetch_tag_post_api_v1_tiktok_web_fetch_tag_post_get_0(challenge_id, count=count, cursor=cursor)
...
cursor = 0 # int | 翻页游标/Page cursor (optional) (default to 0)
    ...
    try:
        # Tag作品/Tag Post
        api_response = api_instance.fetch_tag_post_api_v1_tiktok_web_fetch_tag_post_get_0(challenge_id, count=count, cursor=cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_tag_post_api_v1_tiktok_web_fetch_tag_post_get_0: %s\n" % e)
```
...
# **fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get**
> ResponseModel fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get(live_room_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    live_room_url = 'https://www.tiktok.com/@.caseoh_daily/live' # str | 直播间链接/Live room link

    try:
        # 通过直播链接获取直播间信息/Get live room information via live link
        api_response = api_instance.fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get(live_room_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get: %s\n" % e)
```
...
# **fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get_0**
> ResponseModel fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get_0(live_room_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 通过直播链接获取直播间信息/Get live room information via live link
        api_response = api_instance.fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get_0(live_room_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_tiktok_live_data_api_v1_tiktok_web_fetch_tiktok_live_data_get_0: %s\n" % e)
```
...
# **fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get**
> ResponseModel fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取每日热门内容作品数据/Get daily trending video data
        api_response = api_instance.fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get: %s\n" % e)
```
...
# **fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get_0**
> ResponseModel fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取每日热门内容作品数据/Get daily trending video data
        api_response = api_instance.fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_trending_post_api_v1_tiktok_web_fetch_trending_post_get_0: %s\n" % e)
```
...
# **fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get**
> ResponseModel fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get(cookie, sec_uid, cursor=cursor, count=count, cover_format=cover_format)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    cookie = 'Your_Cookie' # str | 用户cookie/User cookie
sec_uid = 'Your_SecUid' # str | 用户secUid/User secUid
cursor = 0 # int | 翻页游标/Page cursor (optional) (default to 0)
count = 30 # int | 每页数量/Number per page (optional) (default to 30)
cover_format = 2 # int | 封面格式/Cover format (optional) (default to 2)

    try:
        # 获取用户的收藏列表/Get user favorites
        api_response = api_instance.fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get(cookie, sec_uid, cursor=cursor, count=count, cover_format=cover_format)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get: %s\n" % e)
```
 ...
 **cursor** | **int**| 翻页游标/Page cursor | [optional] [default to 0]
 **count** | **int**| 每页数量/Number per page | [optional] [default to 30]
 **cover_format** | **int**| 封面格式/Cover format | [optional] [default to 2]
...
# **fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get_0**
> ResponseModel fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get_0(cookie, sec_uid, cursor=cursor, count=count, cover_format=cover_format)
...
cover_format = 2 # int | 封面格式/Cover format (optional) (default to 2)
    ...
    try:
        # 获取用户的收藏列表/Get user favorites
        api_response = api_instance.fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get_0(cookie, sec_uid, cursor=cursor, count=count, cover_format=cover_format)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_collect_api_v1_tiktok_web_fetch_user_collect_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_fans_api_v1_tiktok_web_fetch_user_fans_get(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    sec_uid = 'MS4wLjABAAAAv7iSuuXDJGDvJkmH_vz1qkDZYo1apxgzaxdBSeIuPiM' # str | 用户secUid/User secUid
count = 30 # int | 每页数量/Number per page (optional) (default to 30)
max_cursor = 0 # int | 最大游标/Max cursor (optional) (default to 0)
min_cursor = 0 # int | 最小游标/Min cursor (optional) (default to 0)

    try:
        # 获取用户的粉丝列表/Get user followers
        api_response = api_instance.fetch_user_fans_api_v1_tiktok_web_fetch_user_fans_get(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_fans_api_v1_tiktok_web_fetch_user_fans_get: %s\n" % e)
```
 ...
 **sec_uid** | **str**| 用户secUid/User secUid | 
 **count** | **int**| 每页数量/Number per page | [optional] [default to 30]
 **max_cursor** | **int**| 最大游标/Max cursor | [optional] [default to 0]
 **min_cursor** | **int**| 最小游标/Min cursor | [optional] [default to 0]
...
# **fetch_user_fans_api_v1_tiktok_web_fetch_user_fans_get_0**
> ResponseModel fetch_user_fans_api_v1_tiktok_web_fetch_user_fans_get_0(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
...
min_cursor = 0 # int | 最小游标/Min cursor (optional) (default to 0)
    ...
    try:
        # 获取用户的粉丝列表/Get user followers
        api_response = api_instance.fetch_user_fans_api_v1_tiktok_web_fetch_user_fans_get_0(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_fans_api_v1_tiktok_web_fetch_user_fans_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_follow_api_v1_tiktok_web_fetch_user_follow_get(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
...
min_cursor = 0 # int | 最小游标/Min cursor (optional) (default to 0)
    ...
    try:
        # 获取用户的关注列表/Get user followings
        api_response = api_instance.fetch_user_follow_api_v1_tiktok_web_fetch_user_follow_get(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_follow_api_v1_tiktok_web_fetch_user_follow_get: %s\n" % e)
```
...
# **fetch_user_follow_api_v1_tiktok_web_fetch_user_follow_get_0**
> ResponseModel fetch_user_follow_api_v1_tiktok_web_fetch_user_follow_get_0(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
...
min_cursor = 0 # int | 最小游标/Min cursor (optional) (default to 0)
    ...
    try:
        # 获取用户的关注列表/Get user followings
        api_response = api_instance.fetch_user_follow_api_v1_tiktok_web_fetch_user_follow_get_0(sec_uid, count=count, max_cursor=max_cursor, min_cursor=min_cursor)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_follow_api_v1_tiktok_web_fetch_user_follow_get_0: %s\n" % e)
```
...
# **fetch_user_like_api_v1_tiktok_web_fetch_user_like_get**
> ResponseModel fetch_user_like_api_v1_tiktok_web_fetch_user_like_get(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    sec_uid = 'MS4wLjABAAAAq1iRXNduFZpY301UkVpJ1eQT60_NiWS9QQSeNqmNQEDJp0pOF8cpleNEdiJx5_IU' # str | 用户secUid/User secUid
cursor = 0 # int | 翻页游标/Page cursor (optional) (default to 0)
count = 20 # int | 每页数量/Number per page (optional) (default to 20)
cover_format = 2 # int | 封面格式/Cover format (optional) (default to 2)
post_item_list_request_type = 0 # int | 排序方式/Sort type (optional) (default to 0)

    try:
        # 获取用户的点赞列表/Get user likes
        api_response = api_instance.fetch_user_like_api_v1_tiktok_web_fetch_user_like_get(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_like_api_v1_tiktok_web_fetch_user_like_get: %s\n" % e)
```
 ...
 **count** | **int**| 每页数量/Number per page | [optional] [default to 20]
 **cover_format** | **int**| 封面格式/Cover format | [optional] [default to 2]
 **post_item_list_request_type** | **int**| 排序方式/Sort type | [optional] [default to 0]
...
# **fetch_user_like_api_v1_tiktok_web_fetch_user_like_get_0**
> ResponseModel fetch_user_like_api_v1_tiktok_web_fetch_user_like_get_0(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
...
post_item_list_request_type = 0 # int | 排序方式/Sort type (optional) (default to 0)
    ...
    try:
        # 获取用户的点赞列表/Get user likes
        api_response = api_instance.fetch_user_like_api_v1_tiktok_web_fetch_user_like_get_0(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_like_api_v1_tiktok_web_fetch_user_like_get_0: %s\n" % e)
```
...
# **fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get**
> ResponseModel fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get(mix_id, cursor=cursor, count=count)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    mix_id = '7101538765474106158' # str | 合辑id/Mix id
cursor = 0 # int | 翻页游标/Page cursor (optional) (default to 0)
count = 30 # int | 每页数量/Number per page (optional) (default to 30)

    try:
        # 获取用户的合辑列表/Get user mix list
        api_response = api_instance.fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get(mix_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get: %s\n" % e)
```
...
# **fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get_0**
> ResponseModel fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get_0(mix_id, cursor=cursor, count=count)
...
count = 30 # int | 每页数量/Number per page (optional) (default to 30)
    ...
    try:
        # 获取用户的合辑列表/Get user mix list
        api_response = api_instance.fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get_0(mix_id, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_mix_api_v1_tiktok_web_fetch_user_mix_get_0: %s\n" % e)
```
...
# **fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get**
> ResponseModel fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get(sec_uid, cursor=cursor, count=count)
...
count = 30 # int | 每页数量/Number per page (optional) (default to 30)
    ...
    try:
        # 获取用户的播放列表/Get user play list
        api_response = api_instance.fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get(sec_uid, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get: %s\n" % e)
```
...
# **fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get_0**
> ResponseModel fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get_0(sec_uid, cursor=cursor, count=count)
...
count = 30 # int | 每页数量/Number per page (optional) (default to 30)
    ...
    try:
        # 获取用户的播放列表/Get user play list
        api_response = api_instance.fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get_0(sec_uid, cursor=cursor, count=count)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_play_list_api_v1_tiktok_web_fetch_user_play_list_get_0: %s\n" % e)
```
...
# **fetch_user_post_api_v1_tiktok_web_fetch_user_post_get**
> ResponseModel fetch_user_post_api_v1_tiktok_web_fetch_user_post_get(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
...
post_item_list_request_type = 0 # int | 排序方式/Sort type (optional) (default to 0)
    ...
    try:
        # 获取用户的作品列表/Get user posts
        api_response = api_instance.fetch_user_post_api_v1_tiktok_web_fetch_user_post_get(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_post_api_v1_tiktok_web_fetch_user_post_get: %s\n" % e)
```
...
# **fetch_user_post_api_v1_tiktok_web_fetch_user_post_get_0**
> ResponseModel fetch_user_post_api_v1_tiktok_web_fetch_user_post_get_0(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
...
post_item_list_request_type = 0 # int | 排序方式/Sort type (optional) (default to 0)
    ...
    try:
        # 获取用户的作品列表/Get user posts
        api_response = api_instance.fetch_user_post_api_v1_tiktok_web_fetch_user_post_get_0(sec_uid, cursor=cursor, count=count, cover_format=cover_format, post_item_list_request_type=post_item_list_request_type)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_post_api_v1_tiktok_web_fetch_user_post_get_0: %s\n" % e)
```
...
> ResponseModel fetch_user_profile_api_v1_tiktok_web_fetch_user_profile_get(unique_id=unique_id, sec_uid=sec_uid)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    unique_id = '' # str | 用户uniqueId/User uniqueId (optional) (default to '')
sec_uid = '' # str | 用户secUid/User secUid (optional) (default to '')

    try:
        # 获取用户的个人信息/Get user profile
        api_response = api_instance.fetch_user_profile_api_v1_tiktok_web_fetch_user_profile_get(unique_id=unique_id, sec_uid=sec_uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_profile_api_v1_tiktok_web_fetch_user_profile_get: %s\n" % e)
```
...
# **fetch_user_profile_api_v1_tiktok_web_fetch_user_profile_get_0**
> ResponseModel fetch_user_profile_api_v1_tiktok_web_fetch_user_profile_get_0(unique_id=unique_id, sec_uid=sec_uid)
...
sec_uid = '' # str | 用户secUid/User secUid (optional) (default to '')
    ...
    try:
        # 获取用户的个人信息/Get user profile
        api_response = api_instance.fetch_user_profile_api_v1_tiktok_web_fetch_user_profile_get_0(unique_id=unique_id, sec_uid=sec_uid)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->fetch_user_profile_api_v1_tiktok_web_fetch_user_profile_get_0: %s\n" % e)
```
...
# **generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get**
> ResponseModel generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成真实msToken/Generate real msToken
        api_response = api_instance.generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get: %s\n" % e)
```
...
# **generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get_0**
> ResponseModel generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get_0()
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成真实msToken/Generate real msToken
        api_response = api_instance.generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get_0()
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->generate_real_ms_token_api_v1_tiktok_web_generate_real_ms_token_get_0: %s\n" % e)
```
...
# **generate_ttwid_api_v1_tiktok_web_generate_ttwid_get**
> ResponseModel generate_ttwid_api_v1_tiktok_web_generate_ttwid_get(cookie)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成ttwid/Generate ttwid
        api_response = api_instance.generate_ttwid_api_v1_tiktok_web_generate_ttwid_get(cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->generate_ttwid_api_v1_tiktok_web_generate_ttwid_get: %s\n" % e)
```
...
# **generate_ttwid_api_v1_tiktok_web_generate_ttwid_get_0**
> ResponseModel generate_ttwid_api_v1_tiktok_web_generate_ttwid_get_0(cookie)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成ttwid/Generate ttwid
        api_response = api_instance.generate_ttwid_api_v1_tiktok_web_generate_ttwid_get_0(cookie)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->generate_ttwid_api_v1_tiktok_web_generate_ttwid_get_0: %s\n" % e)
```
...
# **generate_xbogus_api_v1_tiktok_web_generate_xbogus_post**
> ResponseModel generate_xbogus_api_v1_tiktok_web_generate_xbogus_post(x_bogus_model=x_bogus_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成xbogus/Generate xbogus
        api_response = api_instance.generate_xbogus_api_v1_tiktok_web_generate_xbogus_post(x_bogus_model=x_bogus_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->generate_xbogus_api_v1_tiktok_web_generate_xbogus_post: %s\n" % e)
```
...
# **generate_xbogus_api_v1_tiktok_web_generate_xbogus_post_0**
> ResponseModel generate_xbogus_api_v1_tiktok_web_generate_xbogus_post_0(x_bogus_model=x_bogus_model)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 生成xbogus/Generate xbogus
        api_response = api_instance.generate_xbogus_api_v1_tiktok_web_generate_xbogus_post_0(x_bogus_model=x_bogus_model)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->generate_xbogus_api_v1_tiktok_web_generate_xbogus_post_0: %s\n" % e)
```
...
# **get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post**
> ResponseModel get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    request_body = ["https://www.tiktok.com/@owlcitymusic/video/7218694761253735723"] # list[str] |  (optional)

    try:
        # 提取列表作品id/Extract list video id
        api_response = api_instance.get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post: %s\n" % e)
```
...
# **get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post_0**
> ResponseModel get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取列表作品id/Extract list video id
        api_response = api_instance.get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_all_aweme_id_api_v1_tiktok_web_get_all_aweme_id_post_0: %s\n" % e)
```
...
# **get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post**
> ResponseModel get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    request_body = ["https://www.tiktok.com/@tiktok"] # list[str] |  (optional)

    try:
        # 提取列表用户sec_user_id/Extract list user sec_user_id
        api_response = api_instance.get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post: %s\n" % e)
```
...
# **get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post_0**
> ResponseModel get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取列表用户sec_user_id/Extract list user sec_user_id
        api_response = api_instance.get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_all_sec_user_id_api_v1_tiktok_web_get_all_sec_user_id_post_0: %s\n" % e)
```
...
# **get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post**
> ResponseModel get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取列表unique_id/Get list unique_id
        api_response = api_instance.get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post: %s\n" % e)
```
...
# **get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post_0**
> ResponseModel get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post_0(request_body=request_body)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取列表unique_id/Get list unique_id
        api_response = api_instance.get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post_0(request_body=request_body)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_all_unique_id_api_v1_tiktok_web_get_all_unique_id_post_0: %s\n" % e)
```
...
# **get_aweme_id_api_v1_tiktok_web_get_aweme_id_get**
> ResponseModel get_aweme_id_api_v1_tiktok_web_get_aweme_id_get(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    url = 'https://www.tiktok.com/@owlcitymusic/video/7218694761253735723' # str | 作品链接/Video link

    try:
        # 提取单个作品id/Extract single video id
        api_response = api_instance.get_aweme_id_api_v1_tiktok_web_get_aweme_id_get(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_aweme_id_api_v1_tiktok_web_get_aweme_id_get: %s\n" % e)
```
...
# **get_aweme_id_api_v1_tiktok_web_get_aweme_id_get_0**
> ResponseModel get_aweme_id_api_v1_tiktok_web_get_aweme_id_get_0(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取单个作品id/Extract single video id
        api_response = api_instance.get_aweme_id_api_v1_tiktok_web_get_aweme_id_get_0(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_aweme_id_api_v1_tiktok_web_get_aweme_id_get_0: %s\n" % e)
```
...
# **get_live_room_id_api_v1_tiktok_web_get_live_room_id_get**
> ResponseModel get_live_room_id_api_v1_tiktok_web_get_live_room_id_get(live_room_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    live_room_url = 'https://www.tiktok.com/@maksukaracun/live' # str | 直播间链接/Live room link

    try:
        # 根据直播间链接提取直播间ID/Extract live room ID from live room link
        api_response = api_instance.get_live_room_id_api_v1_tiktok_web_get_live_room_id_get(live_room_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_live_room_id_api_v1_tiktok_web_get_live_room_id_get: %s\n" % e)
```
...
# **get_live_room_id_api_v1_tiktok_web_get_live_room_id_get_0**
> ResponseModel get_live_room_id_api_v1_tiktok_web_get_live_room_id_get_0(live_room_url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 根据直播间链接提取直播间ID/Extract live room ID from live room link
        api_response = api_instance.get_live_room_id_api_v1_tiktok_web_get_live_room_id_get_0(live_room_url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_live_room_id_api_v1_tiktok_web_get_live_room_id_get_0: %s\n" % e)
```
...
# **get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get**
> ResponseModel get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tikhub_sdk_v2.TikTokWebAPIApi(api_client)
    url = 'https://www.tiktok.com/@tiktok' # str | 用户主页链接/User homepage link

    try:
        # 提取用户sec_user_id/Extract user sec_user_id
        api_response = api_instance.get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **url** | **str**| 用户主页链接/User homepage link | 
...
# **get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get_0**
> ResponseModel get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get_0(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 提取用户sec_user_id/Extract user sec_user_id
        api_response = api_instance.get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get_0(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_sec_user_id_api_v1_tiktok_web_get_sec_user_id_get_0: %s\n" % e)
```
...
# **get_unique_id_api_v1_tiktok_web_get_unique_id_get**
> ResponseModel get_unique_id_api_v1_tiktok_web_get_unique_id_get(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取用户unique_id/Get user unique_id
        api_response = api_instance.get_unique_id_api_v1_tiktok_web_get_unique_id_get(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_unique_id_api_v1_tiktok_web_get_unique_id_get: %s\n" % e)
```
...
# **get_unique_id_api_v1_tiktok_web_get_unique_id_get_0**
> ResponseModel get_unique_id_api_v1_tiktok_web_get_unique_id_get_0(url)
...
with tikhub_sdk_v2.ApiClient(configuration) as api_client:
    ...
    try:
        # 获取用户unique_id/Get user unique_id
        api_response = api_instance.get_unique_id_api_v1_tiktok_web_get_unique_id_get_0(url)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling TikTokWebAPIApi->get_unique_id_api_v1_tiktok_web_get_unique_id_get_0: %s\n" % e)
```
