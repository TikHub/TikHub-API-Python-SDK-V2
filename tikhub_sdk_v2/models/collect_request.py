...
class CollectRequest(object):
    ...
    def __init__(self, aweme_id='7419966340443819295', cookie='Your_Cookie_From_Browser', device_id='', iid='', proxy='', local_vars_configuration=None):  # noqa: E501
        """CollectRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def aweme_id(self):
        """Gets the aweme_id of this CollectRequest.  # noqa: E501
        ...
        :return: The aweme_id of this CollectRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def aweme_id(self, aweme_id):
        """Sets the aweme_id of this CollectRequest.

        AKA Video ID，Video ID, which can be obtained from the sharing link, for example: https://www.tiktok.com/@username/video/7419966340443819295  # noqa: E501

        :param aweme_id: The aweme_id of this CollectRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cookie(self):
        """Gets the cookie of this CollectRequest.  # noqa: E501
        ...
        :return: The cookie of this CollectRequest.  # noqa: E501
        :rtype: str
        """
        return self._cookie
    ...
    def cookie(self, cookie):
        """Sets the cookie of this CollectRequest.

        User Cookie，User Cookie, you can log in to your TikTok account in the browser and then copy the Cookie information, please use URL-encoded Cookie string when submitting.  # noqa: E501

        :param cookie: The cookie of this CollectRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def device_id(self):
        """Gets the device_id of this CollectRequest.  # noqa: E501
        ...
        :return: The device_id of this CollectRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def device_id(self, device_id):
        """Sets the device_id of this CollectRequest.

        Device ID，Device id, optional, if not filled in, it will be automatically generated, if you need to customize the device id, please use the device information interface to get the device id.  # noqa: E501

        :param device_id: The device_id of this CollectRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def iid(self):
        """Gets the iid of this CollectRequest.  # noqa: E501
        ...
        :return: The iid of this CollectRequest.  # noqa: E501
        :rtype: str
        """
        return self._iid
    ...
    @iid.setter
    def iid(self, iid):
        """Sets the iid of this CollectRequest.

        Device Install ID，Device install id, optional, if not filled in, it will be automatically generated, if you need to customize the device iid, please use the device information interface to get the device iid.  # noqa: E501

        :param iid: The iid of this CollectRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def proxy(self):
        """Gets the proxy of this CollectRequest.  # noqa: E501
        ...
        :return: The proxy of this CollectRequest.  # noqa: E501
        :rtype: str
        """
        return self._proxy
    ...
    def proxy(self, proxy):
        """Sets the proxy of this CollectRequest.

        Proxy IP，Proxy IP, optional, if not filled in, it will be automatically generated, if you need to customize the proxy IP, please use the proxy IP interface to get the proxy IP.  # noqa: E501

        :param proxy: The proxy of this CollectRequest.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectRequest):
            return False
