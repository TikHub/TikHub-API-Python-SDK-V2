...
from tikhub_sdk_v2.models.http_validation_error import HttpValidationError  # noqa: E501
...
class TestHttpValidationError(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tikhub_sdk_v2.models.http_validation_error.HttpValidationError()  # noqa: E501
        if include_optional :
            return HttpValidationError(
                detail = [
                    tikhub_sdk_v2.models.validation_error.ValidationError(
                        loc = [
                            null
                            ], 
                        msg = '0', 
